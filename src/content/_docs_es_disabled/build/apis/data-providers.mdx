...
description: "Accede a datos de la blockchain de Aptos a través de interfaces SQL y dashboards de análisis para análisis de datos agregados"
sidebar:
...
Acceder directamente al nodo completo te dará los datos más recientes (faltarán históricos a menos que sea un nodo completo de archivo) usando la [API REST](/es/build/apis#aptos-fullnode)

La capa del indexador sobre esto proporcionará una [transmisión de transacciones GRPC](/es/build/indexer/txn-stream/aptos-hosted-txn-stream)

Sobre esta transmisión de transacciones, hemos construido algunas tablas de lógica de producto que pueden ser consultadas a través de [GraphQL](/es/build/indexer)
...
Un [subconjunto de proveedores](https://aptosnetwork.com/currents/aptos-on-chain-data-capabilities-with-dune-nansen-and-other-providers) se lista abajo
...
Tenemos un dashboard aquí: [https://dune.com/aptos/aptos-chain-metrics-overview](https://dune.com/aptos/aptos-chain-metrics-overview)

### Allium

Fuente de datos para muchos proveedores aguas abajo como defillama y rwa.xyz. Los datos sin procesar están disponibles: [https://docs.allium.so/historical-data/supported-blockchains/move-ecosystem/aptos](https://docs.allium.so/historical-data/supported-blockchains/move-ecosystem/aptos)
También tienen transferencias para stablecoins [https://docs.allium.so/historical-data/stablecoins#stablecoin-metrics](https://docs.allium.so/historical-data/stablecoins#stablecoin-metrics)
...
Tienen una guía aquí: [https://docs.sentio.xyz/docs/aptos](https://docs.sentio.xyz/docs/aptos)
...
Los datos se pueden encontrar aquí: [https://app.rwa.xyz/networks/aptos](https://app.rwa.xyz/networks/aptos)
Necesitarás hacer una cuenta para acceder a detalles de stablecoins.

### Flipside

Ha cambiado de proveedor de dashboard a más una herramienta de codificación de vibra. [https://flipsidecrypto.xyz/home/](https://flipsidecrypto.xyz/home/)
