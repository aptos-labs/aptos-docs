...
description: "Guía completa para compilar, probar, publicar y ejecutar contratos inteligentes Move usando la CLI de Aptos con ejemplos y mejores prácticas."
sidebar:
  label: "Herramientas Move"
---
...
Para documentación más detallada sobre argumentos específicos y casos de uso avanzados, consulta la [documentación completa](/es/build/cli/working-with-move-contracts) en inglés.
