...
description: "Guía de referencia para integrar varios proveedores de oráculos como Pyth Network para acceder a datos off-chain en contratos inteligentes."
sidebar:
  label: "Oráculos"
---
...
<Aside type="note" emoji="ℹ️">
  ...
  obtenido de Hermes; Consulta [Obtener Actualizaciones de Precios](https://docs.pyth.network/price-feeds/fetch-price-updates) para
