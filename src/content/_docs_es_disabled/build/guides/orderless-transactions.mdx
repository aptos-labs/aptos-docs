...
description: "Ejecuta transacciones fuera de orden para escenarios de firma multi-máquina manteniendo la protección contra replay y seguridad."
sidebar:
  label: "Transacciones Sin Orden"
---
...
- La [SDK de TypeScript](/es/build/sdks/ts-sdk/building-transactions/orderless-transactions) tiene documentación
