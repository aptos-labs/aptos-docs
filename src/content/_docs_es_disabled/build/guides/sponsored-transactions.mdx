...
description: "Permite a las aplicaciones pagar las tarifas de transacción por los usuarios, simplificando la incorporación al eliminar la necesidad de tokens de gas."
sidebar:
