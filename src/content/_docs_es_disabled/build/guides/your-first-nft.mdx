---
title: "Tu Primer NFT"
description: "Aprende a crear, acuñar y transferir activos digitales (NFTs) en Aptos usando el SDK de TypeScript con ejemplos paso a paso."
sidebar:
  label: "Tu Primer NFT"
---
...
- [Documentación de aptos ts-sdk](/es/build/sdks/ts-sdk)
- [Conceptos básicos de cuenta](/es/network/blockchain/accounts)
- [Especificación de la API REST](/es/rest-api)
