...
description: "Obtén detalles de colecciones NFT poseídas por cuentas incluyendo metadatos de colección, conteos de tokens y atributos completos de colección"
sidebar:
  label: "Colecciones NFT"
---
