...
Si te gustaría leer más sobre configuración en el SDK, echa un vistazo a la guía [Crear un Procesador](/es/build/indexer/indexer-sdk/documentation/create-processor).
