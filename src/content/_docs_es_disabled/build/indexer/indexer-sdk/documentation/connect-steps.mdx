...
A este punto, ya habrías seguido las guías [Crear un Procesador](/es/build/indexer/indexer-sdk/documentation/create-processor) y [Crear un Paso](/es/build/indexer/indexer-sdk/documentation/steps).
