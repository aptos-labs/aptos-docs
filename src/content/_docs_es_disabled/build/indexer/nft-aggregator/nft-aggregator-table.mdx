...
- **[API GraphQL del Agregador NFT](/es/build/indexer/nft-aggregator/graphql-api)**
- **[API REST del Agregador NFT](/es/build/indexer/nft-aggregator/analytics-api)**
...
Más información sobre tablas (ej. `current_token_datas_v2`, `current_collections_v2`, `current_token_ownerships_v2`, `current_collection_ownerships_v2_view`) está disponible [aquí](/es/build/indexer/indexer-api/indexer-reference)
