...
description: "Domina las operaciones de almacenamiento global incluyendo borrow_global, move_to, move_from para gestión de recursos en Aptos."
sidebar:
  label: "Operadores de Almacenamiento"
---
