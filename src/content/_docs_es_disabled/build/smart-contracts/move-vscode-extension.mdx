...
(o simplemente `cargo xtask install --server --client`, ver [https://github.com/matklad/cargo-xtask](https://github.com/matklad/cargo-xtask))
...
Si usas el editor AI [https://www.cursor.com/](https://www.cursor.com/), necesitas hacer un poco más de trabajo.
