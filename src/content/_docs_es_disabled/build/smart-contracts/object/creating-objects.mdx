...
description: "Domina los patrones de creación de objetos, modelos de propiedad y gestión del ciclo de vida en el desarrollo de Move para Aptos."
sidebar:
  label: "Creando Objetos"
---
