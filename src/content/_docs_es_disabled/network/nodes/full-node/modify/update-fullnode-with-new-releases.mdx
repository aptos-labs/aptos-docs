...
3. Descarga el nuevo archivo [genesis.blob](/es/network/nodes/configure/node-files-all-networks/node-files-devnet#genesisblob) y el nuevo [waypoint](/es/network/nodes/configure/node-files-all-networks/node-files-devnet#waypointtxt).
