---
title: "تثبيت CLI Aptos على Linux"
description: "تعليمات خطوة بخطوة لتثبيت CLI Aptos على Linux باستخدام سكريبتات الشل، مديري الحزم، أو الثنائيات المترجمة مسبقًا مع دليل استكشاف الأخطاء."
sidebar:
  label: "تثبيت Linux"
---
...
# التثبيت عبر مدير الحزم (Optional)
...
#### التثبيت عبر AUR (Arch User Repository)
