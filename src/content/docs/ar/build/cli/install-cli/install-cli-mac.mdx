...
<Aside type="caution">
  If `brew` does not work for you, you can try the steps here: [التثبيت عبر السكريبت](#install-via-script) or [التثبيت عبر الثنائيات المترجمة مسبقًا](#install-via-pre-compiled-binaries-backup-method).)
</Aside>
...
# التثبيت عبر السكريبت

<Steps>
  1. في الطرفية، استخدم أحد الأوامر التالية:
...
# التثبيت عبر الثنائيات المترجمة مسبقًا (Backup Method)
