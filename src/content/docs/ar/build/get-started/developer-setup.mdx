...
description: "قم بإعداد بيئة التطوير الخاصة بك لتطبيقات الواجهة الأمامية، العقود الذكية، والتطبيقات الكاملة Aptos مع دليل خطوة بخطوة"
sidebar:
  label: "إعداد المطور"
---
...
<Tabs>
  ...
  <TabItem label="الواجهة الأمامية">
    <Steps>
      1. Initialize الواجهة الأمامية Project
  ...
  <TabItem label="العقد الذكي">
    <Steps>
      ...
      4. Build, Compile, and Deploy العقد الذكي!
         ...
         <CardGrid>
           <LinkCard
             ...
             title="Create العقد الذكي Guide"
  ...
  <TabItem label="إنشاء تطبيق Aptos">
    <Steps>
      ...
      4. Continue reading
         ...
         <CardGrid>
           <LinkCard href="/build/create-aptos-dapp" title="إنشاء تطبيق Aptos" description="Get more information about the tool" />
