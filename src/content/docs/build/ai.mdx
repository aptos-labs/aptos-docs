...
| [`/robots.txt`](/robots.txt)                                                         | Includes [Content Signals](https://contentsignals.org/) (`ai-train=yes, search=yes, ai-input=yes`) and an `Agentmap:` pointer to the AI Catalog.                                                                                                                          |
