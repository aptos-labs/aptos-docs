...
description: "Understanding AIP-88 which introduces block epilogue transactions to provide information about executed blocks"
sidebar:
  label: "AIP-88"
---

[AIP-88](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-088-blockepilogue-to-replace-statecheckpoint.md) covers
