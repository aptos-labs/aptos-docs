...
description: "Advanced guide to bootstrap and run a public Aptos network using genesis ceremonies, validator configurations, and blockchain initialization."
sidebar:
  label: "Run a Public Network (Advanced)"
---
...
From your Aptos-core repository, build the framework and package it.  Running `cargo run --package framework` will run
the move compiler and build the Aptos framework into a bunch of `.mv` files.
