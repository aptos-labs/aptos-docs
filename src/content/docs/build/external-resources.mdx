...
- [OpenChainBench](https://openchainbench.com/benchmarks/aptos-rpc) — Live RPC latency (p50/p90/p99) for Aptos public nodes (Aptos Labs, PublicNode, Ankr, NodeReal), probed every 60 seconds from 3 global regions. Also covers Move FA token deployment cost and cross-chain finality.
