...
<CardGrid>
  ...
  <LinkCard href="/build/guides/payments" title="Payments" description="End-to-end latency, block times, and fees for transfers, confidential transfers, and other payment flows." />
