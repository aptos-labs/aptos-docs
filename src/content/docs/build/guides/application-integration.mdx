...
<CardGrid>
  <LinkCard href="https://github.com/aptos-labs/aptos-docs/tree/main/apps/app-integration-template" title="Application integration template" description="Minimal Vite + React app with Ethereum (Sepolia) and Aptos flows side by side: connect wallet, balance, transfer, view call, and optional orderless nonce." target="_blank" />
</CardGrid>
