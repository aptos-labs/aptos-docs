...
description: "Create and manage multisig accounts requiring multiple approvals for transactions using Python SDK with practical examples."
sidebar:
  label: "Your First Multisig"
---
