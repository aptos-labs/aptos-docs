...
description: "Reference guide for integrating various oracle providers like Pyth Network to access off-chain data in smart contracts."
sidebar:
  label: "Oracles"
---
