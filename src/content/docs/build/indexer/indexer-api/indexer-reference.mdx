...
| auth\_key                  | String! |             | Derived authentication key.                                 |
...
| Field                      | Type    | Primary Key | Description                                     |
| -------------------------- | ------- | ----------- | ----------------------------------------------- |
| auth\_key                  | String! | Yes         | Authentication key.                             |
...
| -------------------------- | ------- | --------------------------------------------- |
| transaction\_version       | bigint! | Transaction version.                          |
| transaction\_block\_height | bigint! | Block height of the transaction.              |
| signer                     | String! | Signer address.                               |
| is\_sender\_primary        | Boolean | True if this is the primary sender signature. |
...
| multi\_agent\_index        | bigint  | Index among secondary signers.                |
| multi\_sig\_index          | bigint  | Index within a multi-sig authenticator.       |
...
(register, deposit, withdraw, transfer, rollover). Amounts may be encrypted;
`event_data` holds the raw event payload.
...
| voter\_address         | String!   |             | Voter address.                     |
...
| from\_address              | String! | Address offering the token.        |
| to\_address                | String! | Address that can claim the token.  |
| amount                     | numeric | Amount offered.                    |
| property\_version          | numeric | Token v1 property version.         |
...
Distinct pools a delegator participates in, with current pool metadata.
...
Count of active delegators in each pool.
