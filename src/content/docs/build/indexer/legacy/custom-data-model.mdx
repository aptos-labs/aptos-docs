...
description: "Legacy custom data model documentation for deprecated indexer - migrate to modern Indexer SDK for custom processors"
sidebar:
  label: "Custom Data Model (Legacy)"
---
