...
<Aside type="note">
  ...
  Note: indexers cannot be bootstrapped using [a snapshot](../../../../network/nodes/bootstrap-fullnode) or [fast sync](../../../../network/nodes/configure/state-sync.mdx#fast-syncing).
</Aside>
