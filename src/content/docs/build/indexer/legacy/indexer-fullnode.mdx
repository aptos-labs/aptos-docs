...
description: "Legacy indexer fullnode setup documentation - deprecated in favor of modern Transaction Stream Service architecture"
sidebar:
  label: "Indexer Fullnode (Legacy)"
---
