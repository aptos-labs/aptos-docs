---
title: "Swift SDK"
description: "Deprecated community Swift SDK for Aptos. Use AptosKit or an official SDK instead."
sidebar:
  label: "Swift SDK"
  badge:
    text: Deprecated
...
<Aside type="danger" title="Deprecated">
  This community Swift SDK is deprecated and is no longer maintained. For iOS
  development, use [AptosKit in the Kotlin Multiplatform SDK](/build/sdks/community-sdks/kotlin-sdk/for-ios-devs/getting-started),
  or one of the official SDKs: [TypeScript](/build/sdks/ts-sdk),
  [Python](/build/sdks/python-sdk), [Go](/build/sdks/go-sdk), or
  [Rust](/build/sdks/rust-sdk).
</Aside>
