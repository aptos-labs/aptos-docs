...
description: "Deprecated legacy Unity SDK for Aptos. Use TypeScript, Python, Go, or Rust instead."
sidebar:
...
<Aside type="danger" title="Deprecated">
  This legacy Unity SDK is deprecated and is no longer maintained. The official
  Unity SDK is also deprecated. For new projects, use the
  [TypeScript SDK](/build/sdks/ts-sdk), [Python SDK](/build/sdks/python-sdk),
  [Go SDK](/build/sdks/go-sdk), or [Rust SDK](/build/sdks/rust-sdk).
</Aside>
