...
description: "Legacy Unity SDK for multi-platform game development on Aptos - now superseded by the official Unity SDK"
sidebar:
...
<Aside type="caution" emoji="❗">
  ...
  SDK](/build/sdks/unity-official-sdk) for the latest features.
</Aside>
