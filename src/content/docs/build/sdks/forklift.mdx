...
<CardGrid>
  <LinkCard href="https://github.com/aptos-labs/forklift" title="Forklift Repository" description="Documentation, API reference, and installation instructions" target="_blank" />

  <LinkCard href="https://github.com/aptos-labs/forklift/tree/main/packages/example-tip-jar" title="TipJar Tutorial" description="Complete walkthrough: develop → test → deploy → interact" target="_blank" />
</CardGrid>
