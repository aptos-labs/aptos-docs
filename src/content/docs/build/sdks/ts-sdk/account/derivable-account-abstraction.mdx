...
description: "Enable deterministic account address derivation with custom authentication schemes using Derivable Account Abstraction"
sidebar:
  label: "Derivable Account Abstraction"
---
