...
3. [Encrypted Mempool](/build/sdks/ts-sdk/building-transactions/encrypted-pending-transactions) - Encrypt the Move payload before it enters the mempool, on networks that support this feature (AIP-144).
