...
description: "Learn how to use Surf for static type safety when interacting with Move contracts, including ABI extraction and type inference"
sidebar:
  label: "Surf (Type Safety)"
---
