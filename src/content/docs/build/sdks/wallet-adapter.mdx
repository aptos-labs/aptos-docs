...
<Aside type="caution" title="Legacy wallet APIs are deprecated">
  Direct wallet access via browser globals (such as `window.aptos` or `window.petra`) is **deprecated** and should not be used. All dapps should use the Wallet Adapter with the [AIP-62](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-62.md) standard for wallet integration.
</Aside>
