...
description: "Implement wallet adapter plugins for browser extension wallets to enable automatic dapp recognition through AIP-62 standard"
sidebar:
  label: "For Browser Extension Wallets"
---
