...
description: "Integrate Aptos wallets into your dapp using the React Provider and Context for seamless wallet connectivity"
sidebar:
  label: "For Dapp Builders"
---
...
<Steps>
  1. Install @aptos-labs/wallet-adapter-react.
     ...
     <Aside type="note">
       All [AIP-62](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-62.md) compatible wallets are detected automatically and work without installing additional packages.
     </Aside>
