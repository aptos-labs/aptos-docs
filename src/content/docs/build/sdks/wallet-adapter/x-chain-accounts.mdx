...
description: "Enable cross-chain wallet integration on Aptos using Derivable Account Abstraction for seamless multi-chain user experiences"
sidebar:
  label: "X-Chain Accounts"
---
...
<Tabs>
  ...
  <TabItem label="Solana">
    ...
    <Aside type="caution">
      Ledger hardware wallets do not currently support off-chain message signing required for Solana-derived Aptos accounts. This is a known limitation of the Ledger Solana app. Users should use software wallets (Phantom, Solflare, etc.) without a hardware device connected
    </Aside>
