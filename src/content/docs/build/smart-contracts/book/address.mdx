...
As with the other scalar values built-in to the language, `address` values are implicitly copyable, meaning they can be copied without an explicit instruction such as [`copy`](../../../../build/smart-contracts/book/variables.mdx#move-and-copy).
