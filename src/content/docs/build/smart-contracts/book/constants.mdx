...
title: "Constants"
label: "Constants"
description: "Learn about constants in Move programming language for Aptos smart contract development."
sidebar:
  label: "Constants"
---
...
A builtin constant can be shadowed by a user declaration. For example, the following is valid code created before
