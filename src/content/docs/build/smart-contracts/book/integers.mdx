...
title: "Integers"
label: "Integers"
description: "Learn about integers in Move programming language for Aptos smart contract development."
sidebar:
  label: "Integers"
---
...
|---------|---------------------|--------------------------------------------|
| `a + b` | addition            | Result is too large for the integer type   |
| `a - b` | subtraction         | Result is less than zero                   |
| `a * b` | multiplication      | Result is too large for the integer type   |
| `a % b` | modular division    | The divisor is `0`                         |
| `a / b` | truncating division | The divisor is `0`                         |
