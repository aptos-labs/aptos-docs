...
any operation whether it be through an explicit [`copy`](../../../../build/smart-contracts/book/variables.mdx#move-and-copy) instruction
or through a [dereference `*`](../../../../build/smart-contracts/book/references.mdx#reading-and-writing-through-references).
