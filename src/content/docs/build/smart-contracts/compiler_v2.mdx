...
label: "Compiler"
description: "Learn about compiler_v2 for Move smart contract development on Aptos blockchain."
sidebar:
  label: "Move on Aptos Compiler"
---
...
The Move on Aptos compiler supports Move 2, the latest revision of the Move language. Head over to the [release page in the book](https://aptos-labs.github.io/move-book/move-versions.html) to learn more about the new features in Move 2. Starting at Aptos CLI v6.0.0, this language version and the Move on Aptos compiler are the default. Note that Move 2 is generally backwards compatible with Move 1.
