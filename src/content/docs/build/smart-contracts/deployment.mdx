...
description: "Learn about deployment for Move smart contract development on Aptos blockchain."
sidebar:
  label: "Deployment"
---
...
and safely manages access control policies for the code owner. Note that in this context, code refers to [packages](https://aptos-labs.github.io/move-book/modules-and-packages.html).
