...
label: "Digital Asset"
description: "Learn about digital asset for Move smart contract development on Aptos blockchain."
sidebar:
  label: "Digital Asset"
---
...
Transferring a `Token` can be done by calling [`object::transfer`](https://aptos-labs.github.io/framework-book/aptos-framework/object.html#function-transfer).
...
See the `aptos_token` [reference docs](https://aptos-labs.github.io/framework-book/aptos-token-objects/aptos_token.html) for all the helper functions you can use.
...
To mint a soul bound `Token`, you can call [`aptos_token::mint_soul_bound`](https://aptos-labs.github.io/framework-book/aptos-token-objects/aptos_token.html#function-mint_soul_bound) instead:
