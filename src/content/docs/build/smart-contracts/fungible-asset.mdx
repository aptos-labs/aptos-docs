...
description: "Learn about the Aptos Fungible Asset standard for creating and managing fungible tokens on Aptos blockchain with enhanced security and functionality."
sidebar:
...
You can find the complete set of functions that the Fungible Asset Standard provides [here](https://aptos-labs.github.io/framework-book/aptos-framework/fungible_asset.html).
