...
This security checks detects the use of `address` parameters in external function that are not checked for being zero before being used. This could lead to loss of funds or other security issues.⏎
