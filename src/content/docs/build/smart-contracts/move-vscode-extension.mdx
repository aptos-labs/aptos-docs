...
<img src="~/images/move-vscode-extension/inlay_hints.png" alt="inlay_hints" width="650" />

- Real-Time Diagnostics
- [Code suggestions](#code-suggestions-with-fixes)
- `movefmt` Integration

<img src="~/images/move-vscode-extension/format.gif" alt="format.gif" width="650" />
...
<img src="~/images/move-vscode-extension/pre-releases.png" alt="pre-releases.png" width="650" />
...
<img src="~/images/move-vscode-extension/diag_code.png" alt="diag_code.png" width="500" />
...
<img src="~/images/move-vscode-extension/replace_with_method_call.gif" alt="replace_with_method_call" width="650" />

### Use compound assignment expression

**Code**: `replace-with-compound-expr`

<img src="~/images/move-vscode-extension/compound_expr.gif" alt="compound_expr" width="650" />
...
<img src="~/images/move-vscode-extension/vector_index_expr.gif" alt="vector_index_expr" width="650" />
...
<img src="~/images/move-vscode-extension/field_shorthand.gif" alt="field_shorthand" width="650" />
...
<img src="~/images/move-vscode-extension/redundant_cast.gif" alt="redundant_cast" width="650" />
...
<img src="~/images/move-vscode-extension/rename_fix.gif" alt="rename_fix.gif" width="650" />
