...
description: "Master object creation patterns, ownership models, and lifecycle management in Aptos Move development."
sidebar:
...
You can find documentation for all possible `Refs` by looking at the Move reference docs for `0x1::object` [here](https://aptos-labs.github.io/framework-book/aptos-framework/object.html).
