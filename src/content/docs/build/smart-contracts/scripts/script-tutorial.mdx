...
description: "Step-by-step tutorial for creating and deploying Move scripts with practical examples and best practices."
sidebar:
...
This tutorial explains how to write and execute a [Move script](https://aptos-labs.github.io/move-book/modules-and-packages.html). You can use Move scripts to execute a series of commands across published Move module interfaces.
