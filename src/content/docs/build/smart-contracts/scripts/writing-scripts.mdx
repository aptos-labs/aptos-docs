...
description: "Learn how to write Move scripts for batch operations, administrative tasks, and complex transaction flows."
sidebar:
...
[Move Book on Scripts](https://aptos-labs.github.io/move-book/modules-and-packages.html)
