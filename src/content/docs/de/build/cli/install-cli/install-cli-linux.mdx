---
title: "Aptos CLI auf Linux installieren"
description: "Schritt-für-Schritt-Anleitung zur Installation der Aptos CLI auf Linux mit Shell-Skripten, Paketmanagern oder vorkompilierten Binärdateien mit Fehlerbehebungsanleitung."
sidebar:
...
# Über Paketmanager installieren (Optional)
...
#### Über AUR installieren (Arch User Repository)
