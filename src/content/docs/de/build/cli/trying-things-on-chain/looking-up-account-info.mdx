...
description: "Learn how to query on-chain account information including balances, resources, and Move modules using the Aptos CLI with detailed examples and output explanations."
sidebar:
  label: "Account Info"
---
