...
<Aside type="caution">
  Si solo quieres ejecutar tu propia red local para pruebas, puedes aprender cómo hacerlo [aquí](/build/cli/running-a-local-network).
</Aside>
...
Las siguientes secciones dependen de herramientas del código fuente de Aptos. Ver [Construir Aptos Desde el Código Fuente](/network/nodes/building-from-source) para la configuración.
