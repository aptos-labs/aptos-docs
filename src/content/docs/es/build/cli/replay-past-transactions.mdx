...
Alternativamente, si quieres simular una nueva transacción, revisa [Simulación Local, Benchmarking y Perfilado de Gas](/es/build/cli/working-with-move-contracts/local-simulation-benchmarking-and-gas-profiling).
...
Luego puedes encontrar el [reporte de gas generado](/es/gas-profiling/sample-report-2/index.html) en el directorio gas-profiling:
...
Para entender el reporte de gas, por favor consulta [esta sección](/es/build/cli/working-with-move-contracts/local-simulation-benchmarking-and-gas-profiling#understanding-the-gas-report) del tutorial de simulación local.
