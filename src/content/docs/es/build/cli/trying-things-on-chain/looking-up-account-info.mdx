---
title: "Buscar Información de Cuenta en la Cadena usando la CLI de Aptos"
---
...
Puedes buscar recursos y datos que una cuenta tiene en la cadena ejecutando el siguiente comando:

```shellscript filename="Terminal"
aptos account list --account <tu-nombre-de-perfil-o-dirección-de-cuenta>
```

Esto mostrará todos los recursos que una cuenta tiene. Por ejemplo, a continuación se muestra el saldo como `coin:value`, y la moneda asociada para el token de gas nativo APT sería `0x1::aptos_coin::AptosCoin`.
Esto se representa en subdivisiones, así que en este caso es `10^-8` o 8 ceros de puntos decimales.
...
Si te interesa un tipo específico de datos de cuenta, puedes especificar eso con el parámetro `--query`. Las consultas soportadas son:

- `balance` - para ver el saldo actual y una lista de eventos de depósito y retiro.
