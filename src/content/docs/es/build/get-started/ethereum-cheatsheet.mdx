...
<Aside type="tip" title="Workshop Interactivo">
  ...
  | **Estándar FT**            | [ERC-20](https://docs.openzeppelin.com/contracts/4.x/erc20)                                                                    | [Coin](/es/build/smart-contracts/aptos-coin) (legacy) y [Fungible Asset](/es/build/smart-contracts/fungible-asset)                    |
  | **Estándares NFT**         | [ERC-721](https://docs.openzeppelin.com/contracts/4.x/erc721), [ERC-1155](https://docs.openzeppelin.com/contracts/4.x/erc1155) | [Digital Asset](/es/build/smart-contracts/digital-asset)                                                                              |
  | **Interacción Blockchain** | [Librería Ethers.js](https://docs.ethers.org/v6/)                                                                              | [Aptos Typescript SDK](/es/build/sdks/ts-sdk)                                                                                         |
