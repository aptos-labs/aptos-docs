...
Para aprender más sobre las diferencias y similitudes ve [Aprende Aptos](https://learn.aptoslabs.com/tutorials/ethereum-to-aptos-guide/cheat-sheet?workshop=eth-to-aptos)
...
| **Estándar FT**            | [ERC-20](https://docs.openzeppelin.com/contracts/4.x/erc20)                                                                    | [Coin](/es/build/smart-contracts/aptos-coin) (legacy) y [Activo Fungible](/es/build/smart-contracts/fungible-asset)                        |
| **Estándares NFT**         | [ERC-721](https://docs.openzeppelin.com/contracts/4.x/erc721), [ERC-1155](https://docs.openzeppelin.com/contracts/4.x/erc1155) | [Activo Digital](/es/build/smart-contracts/digital-asset)                                                                                 |
| **Interacción con Blockchain** | [Biblioteca Ethers.js](https://docs.ethers.org/v6/)                                                                               | [SDK de TypeScript de Aptos](/es/build/sdks/ts-sdk)                                                                                            |
