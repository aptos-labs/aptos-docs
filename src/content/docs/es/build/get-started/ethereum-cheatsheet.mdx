...
Para aprender más sobre las diferencias y similitudes ve [Aprende Aptos](https://learn.aptoslabs.com/es/tutorials/ethereum-to-aptos-guide/cheat-sheet?workshop=eth-to-aptos)
