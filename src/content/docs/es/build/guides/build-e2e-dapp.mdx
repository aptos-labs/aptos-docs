...
2.  Un proyecto usando [create-aptos-dapp](/build/create-aptos-dapp) que contendrá los archivos de nuestro proyecto, tanto el código client-side (basado en React) como el código Move (nuestro smart contract)
3.  La extensión de VSCode [Move On Aptos](/build/smart-contracts/move-vscode-extension)
...
A continuación, usaremos [create-aptos-dapp](/build/create-aptos-dapp) para crear el proyecto.
...
Finalmente, instalemos la extensión de VSCode [Move On Aptos](/build/smart-contracts/move-vscode-extension).
...
3. [Hacer Fetch de Datos de la Chain](/build/guides/build-e2e-dapp/3-fetch-data-from-chain)
4. [Enviar datos a la chain](/build/guides/build-e2e-dapp/4-submit-data-to-chain)
5. [Manejar Tareas](/build/guides/build-e2e-dapp/5-handle-tasks)

Ahora vamos a [crear el smart contract de Todo List](/build/guides/build-e2e-dapp/1-create-smart-contract).
