...
Este es el primer capítulo del tutorial sobre [construir una dapp de extremo a extremo en Aptos](/es/build/guides/build-e2e-dapp). Si no lo has hecho, revisa esa introducción y asegúrate de que tu entorno cumpla con los [requisitos previos](/es/build/guides/build-e2e-dapp#prerequisites) listados allí.
