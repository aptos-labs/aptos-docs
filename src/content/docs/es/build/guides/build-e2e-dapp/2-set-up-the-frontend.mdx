...
Este es el segundo capítulo del tutorial sobre [construir una dapp de extremo a extremo en Aptos](/es/build/guides/build-e2e-dapp) donde ya has [creado un contrato inteligente](/es/build/guides/build-e2e-dapp/1-create-smart-contract) y ahora estás configurando el frontend.
...
Luego aprende cómo [obtener datos de la cadena](/es/build/guides/build-e2e-dapp/3-fetch-data-from-chain) en el capítulo 3.
