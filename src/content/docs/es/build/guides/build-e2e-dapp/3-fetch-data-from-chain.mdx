...
En el tercer capítulo del tutorial sobre [construir una dapp de extremo a extremo en Aptos](/es/build/guides/build-e2e-dapp), aprenderás a obtener datos de la cadena.
...
Para obtener datos de la cadena, podemos usar el [SDK de TypeScript de Aptos](/es/build/sdks/ts-sdk). El SDK proporciona clases y funciones para que podamos interactuar y consultar fácilmente la cadena de Aptos.
