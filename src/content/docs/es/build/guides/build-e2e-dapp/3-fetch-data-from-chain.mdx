...
En el tercer capítulo del tutorial sobre [cómo construir una dapp end-to-end en Aptos](/build/guides/build-e2e-dapp), aprenderás a hacer fetch de la data desde la chain.
...
Para traer data de la chain, podemos usar el [Aptos TypeScript SDK](/build/sdks/ts-sdk). El SDK nos provee clases y funciones para interactuar y hacer queries a la chain de Aptos fácilmente.
...
A continuación, entendamos cómo crear una nueva lista [enviando data a la chain](/build/guides/build-e2e-dapp/4-submit-data-to-chain) en el capítulo 4.
