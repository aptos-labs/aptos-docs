...
En el cuarto capítulo del tutorial sobre [construir una dapp de extremo a extremo en Aptos](/es/build/guides/build-e2e-dapp), estarás enviando datos a la cadena.
