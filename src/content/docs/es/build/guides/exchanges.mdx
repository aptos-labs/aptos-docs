...
description: "Guía completa para integrar Aptos y sus activos en exchanges de criptomonedas con seguimiento de saldos y pruebas."
sidebar:
  label: "Integración de Exchange"
---
...
Se sugiere que ejecutes tu propio [full node](/es/network/nodes/full-node) para interactuar con la blockchain de Aptos.
Esto te permitirá consultar la blockchain para obtener el estado más reciente y enviar transacciones.
También puedes usar el [Indexer](/es/build/indexer) para consultar datos on-chain de manera eficiente.
...
y Nombres de Aptos, consulta nuestra página sobre [Cuentas](/es/network/blockchain/accounts).
...
- Un estándar anterior [Coin](/es/build/smart-contracts/aptos-coin) usado por activos en Aptos.
- Un estándar más reciente [Fungible Asset Standard](/es/build/smart-contracts/fungible-asset) que es más completo.
...
Más información en: [Estándar de Coin](/es/build/smart-contracts/aptos-coin)
...
Más información en: [Estándar de Activo Funciable](/es/build/smart-contracts/fungible-asset)
...
Un ejemplo: [https://api.mainnet.aptoslabs.com/v1/transactions/by\\\_version/1750174030](https://api.mainnet.aptoslabs.com/v1/transactions/by\\_version/1750174030)
...
Aquí hay un ejemplo de una moneda migrada con APT: [https://api.mainnet.aptoslabs.com/v1/transactions/by\\\_version/1642580695](https://api.mainnet.aptoslabs.com/v1/transactions/by\\_version/1642580695)
...
Para probar una transferencia, puedes financiar una cuenta con el activo fungible aquí [https://test-token-faucet.vercel.app/](https://test-token-faucet.vercel.app/)
...
[simulando transacciones](/es/network/blockchain/gas-txn-fee#estimating-gas-consumption-via-simulation)
