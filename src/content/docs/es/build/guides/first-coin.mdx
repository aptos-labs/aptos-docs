...
description: "Crea, despliega y acuña tu propia criptomoneda (MoonCoin) en Aptos usando contratos inteligentes Move y múltiples opciones de SDK."
sidebar:
...
- [TypeScript SDK](/es/build/sdks/ts-sdk)
- [Python SDK](/es/build/sdks/python-sdk)
- [REST API specification](/es/rest-api)
