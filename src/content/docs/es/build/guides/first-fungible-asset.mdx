...
Si quieres construir tu propio Activo Funciable, puedes usar [`fa_coin.move`](https://github.com/aptos-labs/aptos-ts-sdk/tree/main/examples/typescript/move/facoin) como punto de partida, o revisar otros ejemplos de código [aquí](https://learn.aptoslabs.com/es/code-examples).
