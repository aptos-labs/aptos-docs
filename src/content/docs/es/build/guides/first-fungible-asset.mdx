---
title: "Tu Primer Activo Fungible"
description: "Construye y despliega FACoin usando el Estándar de Activo Fungible con capacidades integradas de acuñación, transferencia y seguimiento de saldos."
sidebar:
  label: "Primer Activo Fungible"
---
...
You can find the [Move reference for Fungible Assets](/es/move-reference/mainnet/aptos-framework/fungible_asset) for more details on the function signatures and implementation details.
