...
description: "Aprende a compilar, probar, publicar e interactuar con contratos inteligentes Move en la blockchain de Aptos desde la configuración hasta el despliegue."
sidebar:
  label: "Primer Módulo Move"
---
...
<Aside type="note">
  Este tutorial no está destinado a enseñarte los fundamentos de Move. Ese es un tema más largo que se aprende mejor a través del [Libro de Move](/es/build/smart-contracts/book).
</Aside>
...
<Steps>
  1. Instalar la CLI de Aptos
     ...
     [Instala la CLI de Aptos](/es/build/cli) (si aún no lo has hecho).
...
Ahora tu módulo publicado de Move puede ser conectado como una API a través de uno de nuestros [muchos SDK oficiales](/es/build/sdks)!

Aquí hay algunos **pasos sugeridos para obtener una comprensión más profunda de los módulos Move**:

1. Intenta modificar el módulo para añadir una nueva característica. Puedes usar el [Libro de Move](/es/build/smart-contracts/book) para construir tu comprensión de cómo escribir módulos Move.
2. Para entender cómo funciona Move en la cadena, puedes aprender sobre el [sistema de recursos de Move](/es/network/blockchain/resources).
3. Si estás construyendo una aplicación para interactuar con contratos o buscar datos de la cadena, aprende cómo usar los SDKs [aquí](/es/build/sdks).
4. Únete al [Aptos Discord](https://discord.gg/aptoslabs) para conectarte con otros desarrolladores.

## Documentación de Soporte

- [Conceptos básicos de cuenta](/es/network/blockchain/accounts)
- [SDK de TypeScript](/es/build/sdks/ts-sdk)
- [SDK de Python](/es/build/sdks/python-sdk)
- [Especificación de API REST](/es/rest-api)
