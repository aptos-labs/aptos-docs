...
<Aside type="note">
  Este tutorial no pretende enseñarte los fundamentos de Move. Ese es un tema más extenso que se aprende mejor a través del [Move Book](/es/build/smart-contracts/book).
</Aside>
...
Antes de empezar, ve a tu VSCode (o Cursor) e instala la extensión de VSCode [Move On Aptos](/es/build/smart-contracts/move-vscode-extension).
...
¡Ahora tu módulo Move publicado puede ser conectado justo como una API a través de uno de nuestros [muchos SDKs Oficiales](/es/build/sdks)!

Aquí hay algunos **siguientes pasos sugeridos para obtener un entendimiento más profundo de los módulos Move**:

1. Intenta modificar el módulo para agregar una nueva funcionalidad. Puedes usar el [Move Book](/es/build/smart-contracts/book) para construir tu conocimiento sobre cómo escribir módulos Move.
2. Para entender cómo funciona Move on-chain, puedes aprender sobre el [sistema de recursos de Move](/es/network/blockchain/resources).
3. Si estás construyendo una aplicación para interactuar con contratos o buscar datos on-chain, aprende cómo usar los SDKs [aquí](/es/build/sdks).
4. Únete al [Discord de Aptos](https://discord.gg/aptoslabs) para conectar con otros desarrolladores.

## Documentación de soporte

- [Fundamentos de cuentas](/es/network/blockchain/accounts)
- [TypeScript SDK](/es/build/sdks/ts-sdk)
- [Python SDK](/es/build/sdks/python-sdk)
