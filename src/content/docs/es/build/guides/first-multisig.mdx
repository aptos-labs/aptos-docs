...
<Steps>
  ...
  3. Ejecutar el script
     ...
     <Aside type="note">
       Para cada usuario, nota la [dirección de la cuenta](../../../../network/blockchain/accounts.mdx#dirección-de-la-cuenta) y la [clave de autenticación](../../../../network/blockchain/accounts.mdx#clave-de-autenticación) son idénticas, pero la [clave pública](../../../../network/blockchain/accounts.mdx#crear-una-cuenta) es diferente.
