  ...
  <TabItem label="Python">
    ...
    <Steps>
      1. Configurar el cliente
         ...
         NODE_URL = "[https://fullnode.devnet.aptoslabs.com/v1](https://fullnode.devnet.aptoslabs.com/v1)"
         FAUCET_URL = "[https://faucet.devnet.aptoslabs.com](https://faucet.devnet.aptoslabs.com)"
...
- [Firmas Multi-Agent](/build/sdks/ts-sdk/building-transactions/multi-agent-transactions) - Transacciones que requieren múltiples signers
- [Transacciones Patrocinadas](/build/sdks/ts-sdk/building-transactions/sponsoring-transactions) - Hacer que otra cuenta pague los gas fees
- [Batching de Transacciones](/build/sdks/ts-sdk/building-transactions/batching-transactions) - Enviar múltiples transacciones eficientemente
...
- [Tu Primer Módulo Move](/build/guides/first-move-module) - Crea tu propio smart contract
- [Conceptos Básicos de Cuentas](/network/blockchain/accounts)
