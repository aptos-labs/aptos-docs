...
- [Firmas Multi-Agente](/build/sdks/ts-sdk/building-transactions/multi-agent-transactions) - Transacciones que requieren múltiples firmantes
- [Patrocinar Transacciones](/build/sdks/ts-sdk/building-transactions/sponsoring-transactions) - Hacer que otra cuenta pague las tarifas de gas
- [Agrupar Transacciones](/build/sdks/ts-sdk/building-transactions/batching-transactions) - Enviar múltiples transacciones eficientemente
...
- [Tu Primer Módulo Move](/build/guides/first-move-module) - Crea tu propio contrato inteligente
