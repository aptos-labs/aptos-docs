...
- [Multi-Agent Signatures](/es/build/sdks/ts-sdk/building-transactions/multi-agent-transactions) - Transactions requiring multiple signers
- [Sponsoring Transactions](/es/build/sdks/ts-sdk/building-transactions/sponsoring-transactions) - Having another account pay gas fees
- [Batching Transactions](/es/build/sdks/ts-sdk/building-transactions/batching-transactions) - Sending multiple transactions efficiently
...
- [Your First Move Module](/es/build/guides/first-move-module) - Create your own smart contract
- [Account Basics](/es/network/blockchain/accounts)
