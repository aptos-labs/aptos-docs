...
description: "Característica de seguridad avanzada para rotar claves de cuenta para mantener control mientras se cambian las credenciales de autenticación."
sidebar:
  label: "Rotación de Claves"
---
...
<Steps>
  ...
  14. Rotación de claves para un Ledger
      ...
      ver la guía de [Rotación de clave de autenticación para Ledger](/es/build/cli/trying-things-on-chain/ledger#authentication-key-rotation).
</Steps>
