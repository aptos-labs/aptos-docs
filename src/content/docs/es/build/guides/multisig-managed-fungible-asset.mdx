...
description: "Mejora la seguridad de activos fungibles combinando cuentas multisig con el Estándar de Activo Fungible para gestión protegida."
sidebar:
  label: "Activos Fungibles Multisig"
---
...
- [Tu Primer Módulo Move](/es/build/guides/first-move-module)

## Paso 1: Elige un SDK

Este tutorial fue creado para el [SDK de TypeScript](/es/build/sdks/ts-sdk).

¡Otros desarrolladores están invitados a agregar soporte para el [SDK de Python](/es/build/sdks/python-sdk), [SDK de Rust](/es/build/sdks/rust-sdk), [SDK de Go](/es/build/sdks/go-sdk) y [SDK de Unity](/es/build/sdks/unity-sdk)!
