...
description: "Recupera datos históricos de transacciones para cuentas usando consultas GraphQL con versiones de transacciones y orden cronológico"
sidebar:
  label: "Transacciones de Cuenta"
---
