...
description: "Busca nombres de dominio registrados del Servicio de Nombres de Aptos (ANS) para direcciones de cuentas con funcionalidad de búsqueda inversa de dominios"
sidebar:
  label: "Búsqueda ANS"
---
...
`getNameFromAddress` busca un nombre de dominio registrado para una cuenta dada. Por ejemplo, un usuario podría registrar su cuenta con el Servicio de Nombres de Aptos para estar asociado a `love.apt`. Puedes aprender más yendo a [https://www.aptosnames.com/](https://www.aptosnames.com/).
