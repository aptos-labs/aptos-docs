...
description: "Consultar los balances actuales de activos fungibles para cuentas con datos de tenencias en tiempo real y compatibilidad hacia atrás para monedas"
sidebar:
  label: "Balances de Activos"
---
