...
description: "Consultar información de activos fungibles incluyendo símbolo, nombre, decimales y tipos de activos con compatibilidad hacia atrás para monedas"
sidebar:
  label: "Info de Activos"
---
