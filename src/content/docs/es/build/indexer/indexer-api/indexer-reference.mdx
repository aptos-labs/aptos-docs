...
La API del Indexador te permite acceder a datos enriquecidos sobre tokens, activos fungibles y cuentas on-chain usando consultas GraphQL. **Puedes acceder a ella [aquí](/build/indexer/indexer-api).**
...
<Aside type="note">
  ¡Recuerda usar Ctrl + F para encontrar la tabla que te interesa! En caso de duda, también puedes consultar las tablas de Hasura enlazadas en la página de [Acceso a la API del Indexador](/build/indexer/indexer-api) para ver ejemplos de los datos.
</Aside>
...
| nft\_marketplace\_v2\_\*                | Reemplazar con [API del Agregador NFT](/build/indexer/nft-aggregator)                                                                            |
