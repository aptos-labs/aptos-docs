...
description: "Referencia completa de API GraphQL para el Indexador de Aptos con esquemas de tablas, ejemplos de consultas y documentación de campos para tokens y cuentas"
sidebar:
...
The Indexer API allows you to access rich data about tokens, fungible assets, and accounts on-chain using GraphQL queries. **You can access it [here](/es/build/indexer/indexer-api).**
...
<Aside type="note">
  Remember to use Ctrl + F to find the table you are interested in! When in doubt, you may also want to query the Hasura tables linked in the [Indexer API Access](/es/build/indexer/indexer-api) page to see examples of the data inside.
</Aside>
...
| nft\_marketplace\_v2\_\*                | Replace with [NFT Aggregator API](/es/build/indexer/nft-aggregator)                                                                            |
