...
description: "Recupera URIs de metadatos de tokens por nombres de tokens dentro de colecciones para integración de mercados y plataformas NFT"
sidebar:
  label: "Metadatos de Token"
---
