...
2. Identificar las transacciones a probar.
   - Usa transacciones importadas o escribe tus propios scripts Move personalizados para generar transacciones de prueba. Consulta [Guía de Importación de Transacciones](/build/indexer/indexer-sdk/advanced-tutorials/txn-importer) y [Guía de Generación de Transacciones usando Script Move](/build/indexer/indexer-sdk/advanced-tutorials/txn-script) para instrucciones detalladas.
