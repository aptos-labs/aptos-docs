...
<Steps>
  ...
  3. Configurar Cuentas de Prueba
     ...
     2. Configura tantas cuentas como necesites. Estas cuentas serán usadas para enviar las transacciones con script. Consulta la guía [aquí](/es/build/cli/setup-cli) para crear cuentas.
