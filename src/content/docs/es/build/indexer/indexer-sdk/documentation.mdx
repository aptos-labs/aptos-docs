...
1. Recibir un flujo de transacciones de [Transaction Stream](/build/indexer/txn-stream)
...
El SDK de Indexer es útil cuando quieres indexar un contrato personalizado o te das cuenta de que necesitas un nuevo tipo de datos que no está disponible en la [API de Indexer](/build/indexer/indexer-api).
