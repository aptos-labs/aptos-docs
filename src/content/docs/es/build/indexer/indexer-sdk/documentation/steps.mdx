...
Los procesadores centrales de Aptos representan (1) obtener un flujo de transacciones de [Transaction Stream](/build/indexer/txn-stream), (2) extraer los datos, (3) escribir a una base de datos, y (4) rastrear el progreso, cada uno como pasos separados.
...
Lee más sobre cómo parsear tus datos de transacciones [aquí](/build/indexer/indexer-sdk/documentation/steps/parsing-txns).
...
1. `TransactionStreamStep` proporciona un flujo de transacciones de Aptos al procesador. Lee más sobre esto [aquí](/build/indexer/indexer-sdk/documentation/steps/transaction-stream).
...
3. `VersionTrackerStep` rastrea el progreso del procesador y hace checkpoints del progreso del procesador. Lee más sobre esto [aquí](/build/indexer/indexer-sdk/documentation/version-tracking).
