...
description: "Comienza con el SDK del Indexador de Aptos para construir procesadores de Rust personalizados para indexar eventos de blockchain en bases de datos PostgreSQL"
sidebar:
  label: "Inicio Rápido"
---
...
Sigue [esta guía](/es/build/indexer/txn-stream/aptos-hosted-txn-stream#authorization-via-api-key) para obtener un token del Portal de Desarrolladores. Crea una API Key para `Testnet`, ya que este tutorial es para `Testnet`.
