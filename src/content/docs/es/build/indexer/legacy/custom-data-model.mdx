...
<Aside type="caution">
  Esta es documentación para el indexer legacy. Para aprender cómo escribir un procesador personalizado con la pila de indexer más reciente, ver [Procesadores Personalizados](/build/indexer/custom-processors).
</Aside>
...
Ver las instrucciones completas sobre cómo iniciar un fullnode habilitado para indexer en [Fullnode Indexer](/build/indexer/legacy/indexer-fullnode).
