...
description: "Configura el entorno de desarrollo local para el servicio de flujo de transacciones usando Docker compose y scripts de Python para desarrollo de procesadores personalizados"
sidebar:
...
Puedes aprender más sobre la arquitectura del Servicio de Stream de Transacciones [aquí](/es/build/indexer/txn-stream) y el archivo Docker compose [aquí](https://github.com/aptos-labs/aptos-core/blob/main/docker/compose/indexer-grpc/docker-compose.yaml).
