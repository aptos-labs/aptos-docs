...
description: "Set up local development environment for transaction stream service using Docker compose and Python scripts for custom processor development"
sidebar:
