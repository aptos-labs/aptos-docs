...
<CardGrid>
  <LinkCard href="/build/sdks/dotnet-sdk/godot-integration" title="Integración Godot" description="Integra el SDK .NET de Aptos con un proyecto Godot." />

  <LinkCard href="/build/sdks/dotnet-sdk/unity-integration" title="SDK Unity" description="Integra el SDK .NET de Aptos con un proyecto Unity." />
</CardGrid>
