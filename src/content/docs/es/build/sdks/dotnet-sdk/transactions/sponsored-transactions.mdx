...
<LinkCard href="/es/build/sdks/dotnet-sdk/transactions/basic-transactions" title="Transacciones Básicas" description="Aprende cómo construir transacciones básicas con el SDK .NET de Aptos." />
