...
description: "Aprende cómo generar, financiar y gestionar cuentas de Aptos usando el SDK de Go con diferentes esquemas de firma"
sidebar:
  label: "Cuentas"
---
...
En testnet puedes acuñar en la [página de acuñación](/es/network/faucet).
