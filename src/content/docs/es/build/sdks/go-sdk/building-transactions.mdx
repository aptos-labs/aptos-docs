...
<Steps>
  1. Construir
     ...
     1. **La cuenta `Sender`.** <br />Esta cuenta normalmente paga las comisiones de gas por
        esta transacción. Ver [Transacciones Patrocinadas](/es/build/sdks/go-sdk/building-transactions/sponsoring-transactions)
     ...
     <Aside type="note">
       ...
       ser serializados con [Serialización Canónica Binaria (BCS)](/es/build/sdks/go-sdk/building-transactions/bcs-format)
     </Aside>
...
1. [Firmas Multi-Agente](/es/build/sdks/go-sdk/building-transactions/multi-agent-transactions) - Permitir el uso de múltiples cuentas para una sola transacción.
2. [Transacciones Patrocinadas](/es/build/sdks/go-sdk/building-transactions/sponsoring-transactions) - Hacer que otra cuenta pague las comisiones de gas por esta transacción.
3. [Envío de Transacciones por Lote](/es/build/sdks/go-sdk/building-transactions/batching-transactions) - Cómo enviar múltiples transacciones rápidamente desde una sola cuenta.
4. [Serialización Canónica Binaria (BCS)](/es/build/sdks/go-sdk/building-transactions/bcs-format) - El formato utilizado para serializar datos para transacciones de Aptos.
