...
Mira [aquí](/es/build/sdks/go-sdk/building-transactions) para ver el ejemplo completo de cómo construir, simular y enviar una transacción.

También puedes aprender cómo simular transacciones más avanzadas mirando las siguientes guías:

- [Transacciones Patrocinadas](/es/build/sdks/go-sdk/building-transactions/sponsoring-transactions)
- [Transacciones Multi-Agente](/es/build/sdks/go-sdk/building-transactions/multi-agent-transactions)
