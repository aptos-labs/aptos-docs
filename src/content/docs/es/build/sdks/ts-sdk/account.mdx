...
description: "Aprende cómo generar, financiar y gestionar cuentas de Aptos usando el SDK de TypeScript con diferentes esquemas de firma"
sidebar:
  label: "Cuentas"
---
...
Para testnet puedes usar la página de acuñación [aquí](/es/network/faucet).
