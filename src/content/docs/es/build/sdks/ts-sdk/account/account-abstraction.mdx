...
<Steps>
  ...
  7. 7. Conclusión
     ...
     ![Firma de Transacción](~/images/account-abstraction/complex-guide-transaction-signature.png)
</Steps>
...
![UX de Abstracción de Cuenta](~/images/account-abstraction/account-abstraction-ux.png)
