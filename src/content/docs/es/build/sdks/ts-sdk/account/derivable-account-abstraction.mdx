...
DAA difiere de la [Abstracción de Cuenta (AA)](/build/sdks/ts-sdk/account/account-abstraction) vanilla en que, para una `derivable_authentication_function` dada,
...
Más específicamente, esto proporciona una forma flexible y segura de gestionar firmas cross-chain. (ver [cuentas x-chain](/build/sdks/wallet-adapter/x-chain-accounts))
