...
Crear y ejecutar una transacción multi-agente sigue un flujo similar al [flujo de transacción simple](/es/build/sdks/ts-sdk/building-transactions), pero con varias diferencias notables.
