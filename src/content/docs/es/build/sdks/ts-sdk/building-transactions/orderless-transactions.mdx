...
[flujo de transacción simple](/es/build/sdks/ts-sdk/building-transactions), y el
[flujo de transacción multi-agente](/es/build/sdks/ts-sdk/building-transactions/multi-agent-transactions).
...
1. [**Simular** la transacción (opcional)](/es/build/sdks/ts-sdk/building-transactions/simulating-transactions).
