...
Mira [aquí](/es/build/sdks/ts-sdk/building-transactions) para ver el ejemplo completo de cómo construir, simular y enviar una transacción.
...
- [Transacciones patrocinadas](/es/build/sdks/ts-sdk/building-transactions/sponsoring-transactions)
- [Transacciones de múltiples agentes](/es/build/sdks/ts-sdk/building-transactions/multi-agent-transactions)
