...
description: "Aprende cómo recuperar datos en cadena, consultar la API de Indexer y usar funciones de vista con el SDK de TypeScript de Aptos"
sidebar:
  label: "Obtener Datos"
---
...
Detrás de escena, algunas solicitudes usan la [API del Indexador](/es/build/indexer) para acceder a datos que han sido procesados o agregados. Ese análisis adicional puede tomar un poco de tiempo, por lo que los datos pueden estar ligeramente atrasados respecto al ledger más reciente.
