...
description: "Comienza con el SDK de TypeScript de Aptos creando cuentas, financiándolas y transfiriendo tokens APT entre cuentas"
sidebar:
  label: "Quickstart"
---
...
<Steps>
  ...
  6. Enviar Transacciones
     ...
     Puedes enviar transacciones para cambiar el estado de la cadena. Las transacciones te permiten enviar tokens como APT, activar módulos Move, negociar NFTs, y más. Puedes encontrar un tutorial detallado sobre transacciones [aquí](/es/build/sdks/ts-sdk/building-transactions).
