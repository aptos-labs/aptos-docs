...
<Steps>
  1. Instalar @aptos-labs/wallet-adapter-react.
     ...
     <Aside type="note">
       Todas las wallets compatibles con [AIP-62](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-62.md) se detectan automáticamente y funcionan sin instalar paquetes adicionales.
     </Aside>
