...
<Aside type="note">
  Para que una dapp sea fácilmente integrable con una wallet, se recomienda usar el [Estándar de Adaptador de Wallet de Aptos](/es/build/sdks/sdks/wallet-adapter).
</Aside>
