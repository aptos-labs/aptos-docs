  ...
  <TabItem label="EVM">
    ...
    <Steps>
      ...
      2. Import the setupAutomaticEthereumWalletDerivation function
         ...
         Una vez que hayas instalado el paquete `@aptos-labs/derived-wallet-ethereum`, puedes importarlo y usarlo.
         En el mismo archivo donde importas las otras wallets, como `WalletProvider.tsx`, puedes agregar lo siguiente:
...
- Mientras que la cuenta x-chain prioriza DAA, cada cuenta también conserva la wallet de origen, por lo que los desarrolladores deberían poder usarla e interactuar con ella
