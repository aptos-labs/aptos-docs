...
description: "Aprende sobre el estándar de monedas de Aptos para el desarrollo de contratos inteligentes Move en la blockchain de Aptos."
sidebar:
  label: "Estándar de Moneda"
---
