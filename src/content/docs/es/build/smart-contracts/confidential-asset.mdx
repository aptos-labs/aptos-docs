...
description: "Aprende sobre los activos confidenciales en Aptos para transacciones privadas en contratos inteligentes Move."
sidebar:
  label: "Activo Confidencial"
---
...
<Aside type="note">
  ...
  Para ayudar con esto, hemos desarrollado un SDK de TypeScript, con documentación completa disponible [aquí](/es/build/sdks/ts-sdk/confidential-asset).
</Aside>
...
- [SDK de Activo Confidencial](/es/build/sdks/ts-sdk/confidential-asset)
