...
description: "Aprende cómo depurar contratos inteligentes Move en Aptos con herramientas y técnicas de debugging."
sidebar:
  label: "Debugging"
---
...
[imprimir cualquier declaración de depuración que tengas en tu código](/es/build/cli/working-with-move-contracts#printing-debugging-information).
