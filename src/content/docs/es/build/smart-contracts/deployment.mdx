...
description: "Aprende cómo desplegar código en objetos para contratos inteligentes Move en Aptos."
sidebar:
  label: "Despliegue"
---
...
Este documento explica cómo puedes desplegar código en [Objetos](/es/build/smart-contracts/objects). Esta es la forma recomendada de desplegar código en la blockchain, ya que reduce la complejidad del despliegue
y gestiona de forma segura las políticas de control de acceso para el propietario del código. Ten en cuenta que en este contexto, código se refiere a [paquetes](/es/build/smart-contracts/book/packages).
