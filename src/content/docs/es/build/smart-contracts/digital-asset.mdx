...
You can find the addresses of your recently created “unnamed” `Token`s by using the [Aptos Indexer](/es/build/indexer/indexer-api) with queries like the following:
