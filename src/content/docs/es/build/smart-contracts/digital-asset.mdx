...
Transferring a `Token` can be done by calling [`object::transfer`](/es/move-reference/mainnet/aptos-framework/doc/object.md#0x1_object_transfer).
...
See the `aptos_token` [reference docs](/es/move-reference/mainnet/aptos-token-objects/aptos-token) for all the helper functions you can use.
...
To mint a soul bound `Token`, you can call [`aptos_token::mint_soul_bound`](/es/move-reference/mainnet/aptos-token-objects/aptos-token#0x4_aptos_token_mint_soul_bound) instead:
