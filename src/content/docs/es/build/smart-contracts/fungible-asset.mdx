...
Puedes encontrar el conjunto completo de funciones que el Estándar de Activo Fungible proporciona [aquí](/es/move-reference/mainnet/aptos-framework/doc/fungible_asset.md). {/* TODO: Update the Move Reference link once we migrate that page */}
...
<details>
  ...
  <div className="p-8">
    ...
    1. [Balance Node API](/es/build/apis/fullnode-rest-api#tag/accounts/GET/accounts/%7Baddress%7D/balance/%7Basset_type%7D), el asset\_type puede ser tanto coin\_type, como 0x1::aptos\_coin::AptosCoin o dirección de metadatos FA como 0xa, de cualquier manera debería devolver el mismo valor.
