...
description: "Aprende sobre el estándar de activos fungibles (FA) de Aptos para el desarrollo de contratos inteligentes Move."
sidebar:
  label: "Activo Fungible"
---
...
Una vez que hayas creado los Metadatos, también puedes usar el `ConstructorRef` para generar `Ref`s adicionales. Además de los [Refs de Objeto](/es/build/smart-contracts/object/creating-objects) usuales, los FAs definen tres permisos adicionales que puedes generar:
...
Puedes encontrar el conjunto completo de funciones que el Estándar de Activo Fungible proporciona [aquí](/es/move-reference/mainnet/aptos-framework/fungible_asset).
...
<details>
  ...
  <div className="p-8">
    El estándar FA introduce una nueva forma de representar tokens fungibles como [objetos Move](/es/build/smart-contracts/objects), reemplazando el modelo de recurso Coin legacy. Los Activos Fungibles son más componibles y amigables para desarrolladores comparados con Coins legacy.
...
<details>
  ...
  <div className="p-8">
    ...
    1. [Balance Node API](/es/build/apis/fullnode-rest-api), el asset\_type puede ser tanto coin\_type, como 0x1::aptos\_coin::AptosCoin o dirección de metadatos FA como 0xa, de cualquier manera debería devolver el mismo valor.
...
<details>
  ...
  <div className="p-8">
    Puedes [usar la API del Indexador](/es/build/indexer/indexer-api/indexer-reference#current_fungible_asset_balances) para consultar todos los activos fungibles que el usuario posee.
