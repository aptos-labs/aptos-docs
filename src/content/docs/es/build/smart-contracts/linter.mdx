...
description: "Aprende cómo usar el linter de Move para mejorar la calidad del código en contratos inteligentes de Aptos."
sidebar:
  label: "Linter"
---
