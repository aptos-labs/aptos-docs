...
description: "Aprende sobre los módulos en Aptos para el desarrollo de contratos inteligentes Move."
sidebar:
  label: "Modules"
---
...
Aptos permite la publicación sin permisos de [módulos](/es/build/smart-contracts/book/modules-and-scripts)
dentro de un [paquete](/es/build/smart-contracts/book/packages), así como la [actualización](/es/build/smart-contracts/book/package-upgrades)
...
- La función `init_module` juega un papel crucial en la inicialización del módulo:
  ...
  - La función `init_module` puede tener como máximo un parámetro, y su tipo debe ser `&signer`
  - La función `init_module` no debe tener parámetros genéricos
