...
description: "Aprende las mejores prácticas de seguridad para el desarrollo de contratos inteligentes Move en Aptos."
sidebar:
  label: "Directrices de Seguridad"
---
...
Los tipos genéricos pueden ser utilizados para definir funciones y estructuras sobre diferentes tipos de datos de entrada. Al usarlos, asegúrate de que los tipos genéricos sean válidos y sean lo que se espera. [Leer más](/es/build/smart-contracts/book/generics) sobre generics.
...
[Leer más](/es/build/smart-contracts/book/abilities) sobre capacidades.
...
[Leer más](/es/build/smart-contracts/book/integers#operations) sobre operaciones.
...
[Leer más](/es/build/smart-contracts/objects) sobre Objetos de Aptos.
...
Para más información sobre la aleatoriedad y por qué es crucial prevenir la predicción de números aleatorios, consulta esta página: [Guía de Aleatoriedad](/es/build/smart-contracts/randomness).
