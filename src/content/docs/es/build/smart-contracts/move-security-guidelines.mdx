...
Para más información sobre la aleatoriedad y por qué es crucial prevenir la predicción de números aleatorios, consulta esta página: [Guía de Aleatoriedad](https://aptos.dev/es/build/smart-contracts/randomness/).
