...
Esta es la extensión oficial de Visual Studio Code (y Cursor) para [desarrollar contratos inteligentes en el lenguaje Move en la blockchain de Aptos](https://aptos.dev/en/build/smart-contracts).
