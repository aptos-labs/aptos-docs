...
description: "Aprende cómo interactuar con y manipular objetos de Aptos en contratos inteligentes para aplicaciones componibles."
sidebar:
  label: "Usando Objetos"
---

import { Aside } from '@astrojs/starlight/components';

Una vez que hayas creado tu Objeto, puedes usarlo en funciones de entrada de Move, estructuras, transferirlo, y modificarlo usando cualquier ref que generaste durante la [construcción del Objeto](/es/build/smart-contracts/object/creating-objects). A continuación se muestran varias formas de utilizar, gestionar e interactuar con Objetos en Move.
...
En general, los Objetos solo pueden ser modificados con `Refs` generados durante la construcción. Ver [Creating and Configuring Objects](/es/build/smart-contracts/object/creating-objects) para más detalles sobre qué `Refs` están disponibles, cómo generarlos, y cómo usarlos. Esto es cómo agregar recursos adicionales a un Objeto, eliminarlo, y extenderlo.
