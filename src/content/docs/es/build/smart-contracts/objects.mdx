...
description: "Aprende cómo construir con objetos de Aptos para el desarrollo de contratos inteligentes."
sidebar:
  label: "Objetos"
---
...
- [Crear y configurar un nuevo Objeto.](/es/build/smart-contracts/object/creating-objects)
- [Usar Objetos que creaste.](/es/build/smart-contracts/object/using-objects)
