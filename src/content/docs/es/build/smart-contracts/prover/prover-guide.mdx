...
[lenguaje de especificación de Move](/build/smart-contracts/prover/spec-lang). Ver las secciones abajo para detalles.

## Ejecutar Move Prover

Move Prover se invoca a través del [CLI de Aptos](/build/cli). Para
llamar al CLI, debes tener un [_paquete Move_](/build/smart-contracts/book/packages) en su lugar.
...
[Probar Move](/build/cli/working-with-move-contracts#6-optional-formally-verifying-move-scripts)
