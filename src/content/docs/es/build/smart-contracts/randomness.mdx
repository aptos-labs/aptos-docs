...
Asegúrate de tener la última versión de [aptos-cli](/es/build/cli) instalada.
...
La lista completa de funciones de API y documentación puede encontrarse [aquí](https://github.com/aptos-labs/aptos-core/blob/main/aptos-move/framework/aptos-framework/randomness).
...
Si has completado los pasos en la sección ["Construir Aptos CLI"](/es/build/cli),
