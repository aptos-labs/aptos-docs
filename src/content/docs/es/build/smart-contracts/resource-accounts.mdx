...
description: "Aprende sobre las cuentas de recurso para el desarrollo de contratos inteligentes Move en Aptos."
sidebar:
  label: "Cuentas de Recurso"
---

[Despliegue de Código de Objeto](/es/build/smart-contracts/deployment) es el método preferido para desplegar y actualizar contratos inteligentes en Aptos. Las cuentas de recurso requieren que los desarrolladores generen semillas
