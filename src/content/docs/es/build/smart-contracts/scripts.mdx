...
description: "Guía para construir con scripts de Move para operaciones de blockchain en Aptos."
sidebar:
  label: "Scripts"
---
...
- [Escribir scripts](/es/build/smart-contracts/scripts/writing-scripts)
- [Compilar scripts](/es/build/smart-contracts/scripts/compiling-scripts)
- [Ejecutar scripts](/es/build/smart-contracts/scripts/running-scripts)

# Más detalles

Para más detalles sobre Scripts de Move, consulta:

- [Libro de Move sobre Scripts](/es/build/smart-contracts/book/modules-and-scripts)
- [Tutorial sobre Scripts](/es/build/smart-contracts/scripts/script-tutorial)
