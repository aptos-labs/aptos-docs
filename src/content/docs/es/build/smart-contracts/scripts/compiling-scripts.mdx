...
description: "Comprende cómo compilar scripts de Move con configuración adecuada y preparación para despliegue."
sidebar:
  label: "Compilando Scripts"
---

Los scripts de Move pueden ser compilados con el compilador de Move de Aptos ya existente en
la CLI de Aptos. Para más información sobre cómo instalar y usar la CLI de Aptos con contratos de Move, ve a la página [Trabajando con Contratos de Move](/es/build/cli/working-with-move-contracts).
