...
Este tutorial explica cómo escribir y ejecutar un [script de Move](/es/build/smart-contracts/book/modules-and-scripts). Puedes usar scripts de Move para ejecutar una serie de comandos a través de interfaces de módulos Move publicados.

Para más información sobre scripts, ver la [documentación de scripts de Move](/es/build/smart-contracts/scripts)
...
Repasemos cómo ejecutar un script de Move con un ejemplo paso a paso usando el [CLI de Aptos](/es/build/cli/working-with-move-contracts).
...
2. Configura el CLI de Aptos y [crea una cuenta](/es/build/cli/setup-cli):
