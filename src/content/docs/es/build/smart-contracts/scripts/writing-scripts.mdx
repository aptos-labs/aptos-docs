...
description: "Aprende cómo escribir scripts de Move para operaciones por lotes, tareas administrativas y flujos de transacciones complejas."
sidebar:
  label: "Escribiendo Scripts"
---
...
[Move Book sobre Scripts](/es/build/smart-contracts/book/modules-and-scripts)
