...
description: "Aprende sobre los tokens y estándares de tokenización en Move para el desarrollo de contratos inteligentes en Aptos."
sidebar:
  label: "Tokens"
---

El [Estándar de Activo Digital de Aptos](/es/build/smart-contracts/digital-asset) define el
...
el [estándar de Activo Fungible](/es/build/smart-contracts/fungible-asset). El concepto de
composabilidad viene del modelo de datos subyacente para estas construcciones:
el modelo de datos de [Objeto Move](/es/build/smart-contracts/objects).
...
Las [cuentas](/es/network/blockchain/accounts) en Aptos almacenan tanto contratos inteligentes
...
en [recursos](/es/network/blockchain/resources)
dentro de [cuentas](/es/network/blockchain/accounts)
o [objetos](/es/build/smart-contracts/objects). Por ejemplo, una colección y un
