...
<Aside type="note">
  Recomendamos encarecidamente que leas sobre [Staking](/network/blockchain/staking) primero.
</Aside>
...
<Aside type="caution">
  ...
  del pool de stake, ver [Staking](/network/blockchain/staking)
</Aside>
...
Ver lista completa de [Operaciones de Pool de Delegación](/network/nodes/validator-node/connect-nodes/delegation-pool-operations)
...
[Cómo funciona la Validación en la blockchain de Aptos](/network/blockchain/staking#validation-on-the-aptos-blockchain)
...
<Aside type="note">
  Este documento describe el staking. Ver [Gobernanza](/network/blockchain/governance) para cómo
...
<Aside type="note">
  ...
  delegación](/network/nodes/validator-node/connect-nodes/delegation-pool-operations)
  para la secuencia correcta de comandos a ejecutar para el flujo siguiente.
</Aside>

1. [El operador despliega el nodo validator](/network/nodes/validator-node)
2. [Ejecutar comando para obtener la dirección del pool de delegación](/network/nodes/validator-node/connect-nodes/delegation-pool-operations#prerequisites)
3. [El operador se conecta a la red usando la dirección del pool derivada en el paso 2](/network/nodes/validator-node/connect-nodes/connect-to-aptos-network)
4. [El propietario inicializa el pool de delegación y establece el operador](/network/nodes/validator-node/connect-nodes/delegation-pool-operations#initialize-a-delegation-pool)
...
<Aside type="note">
  ...
  Conjunto de
  Validators](/network/nodes/validator-node/connect-nodes/connect-to-aptos-network#join-the-validator-set).
</Aside>
...
3. [Rendimiento de recompensas del validator](/network/blockchain/staking#rewards-formula)

Ver [Calculando recompensas del pool de delegación](/network/nodes/validator-node/connect-nodes/delegation-pool-operations#compute-delegation-pool-rewards-earned)
