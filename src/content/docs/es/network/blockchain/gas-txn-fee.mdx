...
Para información más detallada sobre la estructura interna del gas y optimizaciones, consulta la [documentación completa](/network/blockchain/gas-txn-fee) en inglés.
