...
<Aside type="note">
  Recomendamos encarecidamente que leas la sección de consenso de [Inmersión Profunda en la Blockchain de Aptos](/network/blockchain/blockchain-deep-dive#consensus) antes de continuar.
</Aside>
...
<Aside type="note">
  Este documento describe staking. Ver [Gobernanza](/network/blockchain/governance) para cómo participar en la gobernanza on-chain de Aptos usando el modelo owner-voter.
</Aside>
...
<Aside type="note">
  Ver [Operaciones de pool de staking](/network/nodes/validator-node/connect-nodes/staking-pool-operations) para la secuencia correcta de comandos a ejecutar para el flujo siguiente.
</Aside>
...
<Aside type="note">
  Para instrucciones paso a paso sobre cómo unirse al conjunto de validators, ver: [Unirse al Conjunto de Validators](/network/nodes/validator-node/connect-nodes/connect-to-aptos-network#join-the-validator-set).
</Aside>
...
1. El operador [solicita desbloqueo de comisión](/network/nodes/validator-node/connect-nodes/staking-pool-operations#requesting-commission)
...
- [Operaciones de Pool de Staking](/network/nodes/validator-node/connect-nodes/staking-pool-operations)
- [Operaciones de Pool de Delegación](/network/nodes/validator-node/connect-nodes/delegation-pool-operations)
