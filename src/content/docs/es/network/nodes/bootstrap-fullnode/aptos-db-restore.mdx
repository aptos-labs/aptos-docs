...
El [CLI de Aptos](/build/cli) soporta dos tipos de operaciones de restauración para nodos Aptos:
...
deshabilita el podador siguiendo las instrucciones en la sección [deshabilitar el podador de ledger](/network/nodes/configure/data-pruning) antes de
