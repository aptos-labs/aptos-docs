---
title: "Archivos Para Devnet"
description: "Descarga archivos de configuración requeridos, blob génesis, waypoint, y archivos Docker compose para desplegar nodos Aptos en devnet."
sidebar:
  label: "Archivos Devnet"
---

import { Aside } from '@astrojs/starlight/components';

Cuando despliegues un nodo Aptos en **devnet**, podrías necesitar descargar los archivos listados en esta página. Los archivos están
...
- **Rama Git:** `devnet` en [https://github.com/aptos-labs/aptos-core](https://github.com/aptos-labs/aptos-core)
