---
title: "Archivos Para Testnet"
description: "Descarga archivos de configuración requeridos, blob génesis, waypoint, y archivos Docker compose para desplegar nodos Aptos en testnet."
sidebar:
  label: "Archivos Testnet"
---

import { Aside } from '@astrojs/starlight/components';

Cuando despliegues un nodo Aptos en **testnet**, podrías necesitar descargar los archivos listados en esta página. Los archivos están
...
- **Rama Git:** `testnet` en [https://github.com/aptos-labs/aptos-core](https://github.com/aptos-labs/aptos-core)
