...
<Aside type="tip">
  **¿Necesitas iniciar un nodo rápidamente? Esto es lo que recomendamos:**<br />
  ...
  - **Mainnet**: Para sincronizar todo el historial de blockchain, restaura desde un [backup](/es/network/nodes/bootstrap-fullnode/aptos-db-restore). De lo contrario, usa [sincronización rápida](/es/network/nodes/configure/state-sync#fast-syncing).
  - **Testnet**: Para sincronizar todo el historial de blockchain, restaura desde un [backup](/es/network/nodes/bootstrap-fullnode/aptos-db-restore). De lo contrario, usa [sincronización rápida](/es/network/nodes/configure/state-sync#fast-syncing).
  - **Devnet**: Para sincronizar todo el historial de blockchain, usa [sincronización inteligente](/es/network/nodes/configure/state-sync#intelligent-syncing). De lo contrario, usa [sincronización rápida](/es/network/nodes/configure/state-sync#fast-syncing).
</Aside>
...
<Aside type="caution">
  **¿Sincronizando desde génesis?** <br />
  ...
  tu nodo pueda conectarse a pares con los datos. Ver [Conectarse a Pares Semilla](/es/network/nodes/full-node/modify/fullnode-network-connections#connecting-to-seed-peers).
</Aside>
...
<Aside type="danger">
  **Los nodos archivales están deprecados**<br />
  ...
  Si deseas almacenar y mantener todo el historial de blockchain, recomendamos usar un [Indexer](/es/build/indexer).
</Aside>
...
2. Deshabilitar el podador de ledger, como se describe en el [documento de Poda de Datos](/es/network/nodes/configure/data-pruning#disable-the-ledger-pruner).
...
<Aside type="caution">
  **¿Sincronizando desde génesis?** <br />
  ...
  el archivo de configuración de tu nodo. Ver [Conectarse a Pares Semilla](/es/network/nodes/full-node/modify/fullnode-network-connections#connecting-to-seed-peers).
</Aside>
