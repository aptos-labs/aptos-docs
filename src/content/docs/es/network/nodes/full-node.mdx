...
<Aside type="note">
  **Conexión predeterminada a mainnet**<br />
  ...
  Puedes encontrar los archivos genesis y waypoint para todas las redes, aquí ➜ [https://github.com/aptos-labs/aptos-networks](https://github.com/aptos-labs/aptos-networks).
</Aside>
