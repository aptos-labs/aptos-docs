...
se conecten a ti, como se describe en [Generar una Identidad PFN](/network/nodes/full-node/modify/network-identity-fullnode).
...
<Aside type="note">
  **Generar una identidad estática**<br />
  Antes de permitir que otros nodos se conecten a tu PFN, necesitarás crear una identidad estática. Ver [Generar una Identidad PFN](/network/nodes/full-node/modify/network-identity-fullnode).
</Aside>
...
<Aside type="note">
  **Configuraciones de puerto por defecto**<br />
  ...
  Ver [Requisitos PFN](/network/nodes/full-node/pfn-requirements) para más información sobre configuraciones de puerto.
</Aside>
