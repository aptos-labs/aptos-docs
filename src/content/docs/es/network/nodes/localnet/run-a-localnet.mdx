...
<Aside type="note">
  Es más fácil ejecutar una localnet usando el [CLI de Aptos](/es/network/nodes/localnet/local-development-network) que ejecutarla desde código fuente. El CLI también proporciona una experiencia más amigable al usuario y características adicionales.
  Aprende cómo siguiendo esta guía: [Localnet usando el CLI de Aptos](/es/network/nodes/localnet/local-development-network).
</Aside>
...
1. Sigue los pasos en [Construir Aptos Desde Código Fuente](/es/network/nodes/building-from-source)
...
Usa la [herramienta CLI de Aptos](/es/build/cli) para interactuar con tu localnet. La salida anterior contiene información que usarás para iniciar la [herramienta CLI de Aptos](/es/build/cli):
