...
<Aside type="note">
  ...
  Esta guía también asume que has completado los pasos en [Construir Aptos Desde Código Fuente](/network/nodes/building-from-source).
</Aside>
...
<Aside type="tip">
  ...
  También ver cómo usar el [CLI de Aptos](../../../build/cli) con un faucet existente.
</Aside>
