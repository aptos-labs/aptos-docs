...
Ahora has completado la configuración de tu validator y VFN usando AWS. Procede a [Conectar Nodos](/es/network/nodes/validator-node/connect-nodes) para los siguientes pasos.
