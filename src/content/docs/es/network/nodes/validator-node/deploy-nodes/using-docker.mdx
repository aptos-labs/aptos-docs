...
<Aside type="caution">
  **Usuarios Apple M1+** <br />
  ...
  desplegar usando [código fuente](/network/nodes/full-node/deployments/using-source-code).
</Aside>
...
<Aside type="caution">
  **Prerrequisitos** <br />
  ...
  instalado el [CLI de Aptos](/build/cli), y [Docker con Docker Compose](https://docs.docker.com/engine/install/).
</Aside>
...
4. Descarga los siguientes archivos siguiendo las instrucciones en las páginas [Archivos del Nodo](/network/nodes/configure/node-files-all-networks).
...
Ahora has completado la configuración de tu validator y VFN usando Docker. Procede a [Conectar Nodos](/network/nodes/validator-node/connect-nodes) para los siguientes pasos.
