...
Ahora has completado la configuración de tu validator y VFN usando GCP. Procede a [Conectar Nodos](/network/nodes/validator-node/connect-nodes) para los siguientes pasos.
