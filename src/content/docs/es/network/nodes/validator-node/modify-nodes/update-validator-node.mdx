...
1. Actualiza tu DNS para intercambiar las [direcciones de red](/es/network/nodes/validator-node/connect-nodes/connect-to-aptos-network#3-update-on-chain-network-addresses) entre el validator y VFN.
