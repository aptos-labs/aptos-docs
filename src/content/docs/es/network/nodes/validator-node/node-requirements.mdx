...
<Aside type="note">
  ...
  Ver [**Ejecutar Nodo Validator**](/network/nodes/validator-node/deploy-nodes).
</Aside>
...
sección [**Clonar aptos-core**](/network/nodes/building-from-source#clone-the-aptos-core-repo)).
