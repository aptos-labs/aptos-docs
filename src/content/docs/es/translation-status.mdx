---
title: "Translation Status - Español"
description: "Track the progress of Spanish translation of Aptos documentation"
sidebar:
...
<CardGrid>
  <Card title="Overall Progress" icon="star">
    **340 / 373 pages translated**\
    **91.2% completed**

    <div style="background: #f0f0f0; border-radius: 10px; height: 20px; margin: 10px 0;">
      <div style="background: linear-gradient(90deg, #4CAF50 0%, #8BC34A 100%); width: 91.2%; height: 100%; border-radius: 10px;" />
    </div>
  </Card>
...
Want to help translate the documentation to Spanish?
...
- **Natural style** - Write in natural, fluent Spanish
