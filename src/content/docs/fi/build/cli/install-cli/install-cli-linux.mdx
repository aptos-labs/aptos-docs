---
title: "Aptos CLI:n asennus Linuxiin"
description: "Vaiheittainen opastus Aptos CLI:n asentamiseen Linuxiin käyttäen kuori-skriptejä, paketinhallintaohjelmia tai valmiiksi käännettyjä binaaritiedostoja vianmääritysohjeineen."
sidebar:
  label: "Linux-asennus"
---
...
# Asenna paketinhallintaohjelmalla (Optional)
...
#### Asenna AUR:lla (Arch User Repository)
