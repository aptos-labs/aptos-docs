---
title: "Kehittäjäympäristön asetukset"
description: "Määritä kehitysympäristösi frontend-, älykkäiden sopimusten ja täysstack Aptos -sovellusten kehittämiseen vaiheittaisilla ohjeilla"
sidebar:
  label: "Kehittäjäasetukset"
---
...
<Tabs>
  ...
  <TabItem label="Älykäs sopimus">
    <Steps>
      ...
      4. Build, Compile, and Deploy Älykäs sopimus!
         ...
         <CardGrid>
           <LinkCard
             ...
             title="Create Älykäs sopimus Guide"
  ...
  <TabItem label="Luo Aptos Dapp">
    <Steps>
      ...
      4. Continue reading
         ...
         <CardGrid>
           <LinkCard href="/build/create-aptos-dapp" title="Luo Aptos Dapp" description="Get more information about the tool" />
