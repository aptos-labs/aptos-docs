---
title: "Menginstal CLI Aptos di Linux"
description: "Instruksi langkah demi langkah untuk menginstal CLI Aptos di Linux menggunakan skrip shell, manajer paket, atau biner yang telah dikompilasi sebelumnya dengan panduan pemecahan masalah."
sidebar:
  label: "Instalasi Linux"
---
...
# Instal via Package Manager (Optional)
...
#### Instal via AUR (Arch User Repository)
