---
title: "Trying Things On-Chain With Aptos CLI"
description: "Learn how to interact with the Aptos blockchain using CLI profiles, including account management, transaction sending, and hardware wallet integration."
sidebar:
