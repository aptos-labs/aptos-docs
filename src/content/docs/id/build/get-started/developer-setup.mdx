---
title: "Pengaturan Lingkungan Pengembang"
description: "Siapkan lingkungan pengembangan Anda untuk aplikasi frontend, kontrak pintar, dan full-stack Aptos dengan panduan langkah demi langkah"
sidebar:
  label: "Pengaturan Pengembang"
---
...
<Tabs>
  ...
  <TabItem label="Kontrak Pintar">
    <Steps>
      ...
      4. Build, Compile, and Deploy Kontrak Pintar!
         ...
         <CardGrid>
           <LinkCard
             ...
             title="Create Kontrak Pintar Guide"
  ...
  <TabItem label="Buat Aptos Dapp">
    <Steps>
      ...
      4. Continue reading
         ...
         <CardGrid>
           <LinkCard href="/build/create-aptos-dapp" title="Buat Aptos Dapp" description="Get more information about the tool" />
