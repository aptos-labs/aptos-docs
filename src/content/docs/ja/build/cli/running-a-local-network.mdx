...
description: "Set up and run a local Aptos network for testing and development with Docker, including Node API, Indexer API, and faucet services."
sidebar:
  label: "Run a Local Network"
---
