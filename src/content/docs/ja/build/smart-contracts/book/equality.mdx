...
ただし,プログラマーは値を直接比較する代わりに,_常に_値を借用することができ,参照型は[`drop`アビリティ](/ja/build/smart-contracts/book/abilities)を持っています.例えば:
...
プログラマーは[`drop`](/ja/build/smart-contracts/book/abilities)を持つ任意の値を比較_できますが_,高価なコピーを避けるために参照で比較することが多いでしょう.
