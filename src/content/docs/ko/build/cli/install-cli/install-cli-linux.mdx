---
title: "Linux에 Aptos CLI 설치"
description: "쉘 스크립트, 패키지 관리자 또는 사전 컴파일된 바이너리를 사용하여 Linux에 Aptos CLI를 설치하는 단계별 지침과 문제 해결 가이드."
sidebar:
  label: "Linux 설치"
---
