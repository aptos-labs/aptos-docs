...
<Tabs>
  ...
  <TabItem label="스마트 컨트랙트">
    <Steps>
      ...
      4. Build, Compile, and Deploy 스마트 컨트랙트!
  ...
  <TabItem label="Aptos Dapp 생성">
    <Steps>
      ...
      4. Continue reading
         ...
         <CardGrid>
           <LinkCard href="/build/create-aptos-dapp" title="Aptos Dapp 생성" description="Get more information about the tool" />
