...
description: "Read the official Aptos blockchain white paper outlining the technical design, scalability principles, Move language integration, and architectural innovations."
sidebar:
  label: "White Paper"
---
...
<CardGrid>
  <LinkCard href="https://aptosfoundation.org/whitepaper/aptos-whitepaper_en.pdf" title="🇺🇸 English (en-US) ↗" description="Original Aptos White Paper PDF in English" target="_blank" />

  <LinkCard href="https://aptosfoundation.org/whitepaper/aptos-whitepaper_ko.pdf" title="🇰🇷 한국어 Korean (ko-KR) ↗" description="Aptos White Paper PDF translated to Korean" target="_blank" />

  <LinkCard href="https://aptosfoundation.org/whitepaper/aptos-whitepaper_ja.pdf" title="🇯🇵 日本語 Japanese (ja-JP) ↗" description="Aptos White Paper PDF translated to Japanese" target="_blank" />

  <LinkCard href="https://aptosfoundation.org/whitepaper/aptos-whitepaper_es.pdf" title="🇪🇸 Español Spanish (es-ES) ↗" description="Aptos White Paper PDF translated to Spanish" target="_blank" />
</CardGrid>
