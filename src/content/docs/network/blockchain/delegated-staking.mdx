...
description: "Learn about delegated staking on Aptos, delegation pools, the owner-operator-voter-delegator model, and how to participate in staking without running a validator."
sidebar:
