...
[How Validation on the Aptos blockchain works](../../../network/blockchain/staking.mdx#validation-on-the-aptos-blockchain)
...
2. [Run command to get delegation pool address](../../../network/nodes/validator-node/connect-nodes/delegation-pool-operations.mdx#prerequisites)
...
4. [Owner initializes the delegation pool and sets operator](../../../network/nodes/validator-node/connect-nodes/delegation-pool-operations.mdx#initialize-a-delegation-pool)
...
<Aside type="note">
  ...
  Validator
  Set](../../../network/nodes/validator-node/connect-nodes/connect-to-aptos-network.mdx#join-the-validator-set).
</Aside>
...
2. Delegator stake
3. [Validator rewards performance](../../../network/blockchain/staking.mdx#rewards-formula)

See [Computing delegation pool rewards](../../../network/nodes/validator-node/connect-nodes/delegation-pool-operations.mdx#compute-delegation-pool-rewards-earned)
