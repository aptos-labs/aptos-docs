---
title: "Events"
description: "Understand events on Aptos blockchain, including module events, EventHandle events (deprecated), and how to emit and query events in Move smart contracts."
sidebar:
  label: "Events"
---
