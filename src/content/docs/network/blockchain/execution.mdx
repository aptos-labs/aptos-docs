---
title: "Execution"
description: "Explore transaction execution on Aptos, including deterministic processing, parallel execution with Block-STM, and performance optimizations for high throughput."
sidebar:
  label: "Execution"
---
