...
description: "Learn about Aptos on-chain governance, how to create and vote on proposals, and participate in blockchain upgrade decisions through the democratic process."
sidebar:
  label: "Governance"
---
