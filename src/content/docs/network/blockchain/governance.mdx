...
If you are a [delegated staker](../../../network/blockchain/delegated-staking), follow the instructions for voting [here](../../../network/nodes/validator-node/connect-nodes/staking-pool-voter.mdx#delegation-pool-voter).
