...
- [Archival nodes (ANs)](../../../network/nodes/configure/state-sync.mdx#archival-pfns) - is a fullnode that contains all blockchain data since the start of the blockchain's history.
