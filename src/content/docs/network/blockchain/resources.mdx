...
description: "Learn about Resources in Move on Aptos, how they differ from instances, their permission models, and storage mechanisms for managing on-chain state."
sidebar:
  label: "Resources"
---
