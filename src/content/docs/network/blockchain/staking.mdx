---
title: "Staking"
description: "Understand staking on Aptos blockchain, including validator operations, rewards, lockup periods, and the owner-operator-voter model for network participation."
sidebar:
  label: "Staking"
---
