...
description: "Configure consensus observer to reduce block synchronization time and transaction latencies for public fullnodes (PFNs) by 10-50%."
sidebar:
  label: "Consensus Observer"
---
