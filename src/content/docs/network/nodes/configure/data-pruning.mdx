---
title: "Data Pruning"
description: "Configure blockchain data pruning on Aptos nodes to manage storage space by controlling ledger history retention with customizable pruning windows."
sidebar:
  label: "Data Pruning"
---
...
<Aside type="caution">
  **Default pruning window**<br />
  ...
  an archival node, follow the instructions, [here](/network/nodes/configure/state-sync#archival-pfns).
</Aside>
