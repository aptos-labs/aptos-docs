...
<Aside type="note">
  ...
  - **Devnet**: To sync the entire blockchain history, use [intelligent syncing](../../../../network/nodes/configure/state-sync.mdx#intelligent-syncing). Otherwise, use [fast sync](../../../../network/nodes/configure/state-sync.mdx#fast-syncing).
  - **Testnet**: To sync the entire blockchain history, restore from a [backup](../../../../network/nodes/bootstrap-fullnode/aptos-db-restore). Otherwise, download [a snapshot](../../../../network/nodes/bootstrap-fullnode/bootstrap-fullnode) or use [fast sync](../../../../network/nodes/configure/state-sync.mdx#fast-syncing).
  - **Mainnet**: To sync the entire blockchain history, restore from a [backup](../../../../network/nodes/bootstrap-fullnode/aptos-db-restore). Otherwise, use [fast sync](../../../../network/nodes/configure/state-sync.mdx#fast-syncing).
</Aside>
...
<Aside type="caution">
  **Verify node syncing**<br />
  ...
  [`aptos_state_sync_version{type="synced"}`](../../../../network/nodes/full-node/verify-pfn) metric gradually increase.
</Aside>
...
2. Disable the ledger pruner, as described in the [Data Pruning document](../../../../network/nodes/configure/data-pruning.mdx#disable-the-ledger-pruner).
