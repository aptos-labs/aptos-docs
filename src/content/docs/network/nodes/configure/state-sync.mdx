...
description: "Learn how state synchronization keeps Aptos nodes updated with the latest blockchain state including configuration options and syncing modes."
sidebar:
  label: "State Sync"
---
