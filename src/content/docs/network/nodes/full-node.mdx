...
description: "Deploy and operate your own public fullnode (PFN) to synchronize with the Aptos blockchain and stay up-to-date with the latest state."
sidebar:
  label: "Fullnode Overview"
---
...
<Aside type="note">
  **Default connection to mainnet**<br />
  ...
  You can find the genesis and waypoint files for all the networks, here ➜ [https://github.com/aptos-labs/aptos-networks](https://github.com/aptos-labs/aptos-networks).
</Aside>
