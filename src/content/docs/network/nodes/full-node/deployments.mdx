---
title: "Deploy a PFN"
description: "Step-by-step guides for deploying a public fullnode (PFN) on Aptos networks using various deployment methods including source code, Docker, and cloud platforms."
sidebar:
  label: "Overview"
---
