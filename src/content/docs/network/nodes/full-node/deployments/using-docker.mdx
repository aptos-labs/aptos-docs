...
<Aside type="caution">
  **Don't want to connect to mainnet?**<br />
  To connect to other networks (e.g., `devnet` and `testnet`), you can find the genesis and waypoint here ➜ [https://github.com/aptos-labs/aptos-networks](https://github.com/aptos-labs/aptos-networks).
