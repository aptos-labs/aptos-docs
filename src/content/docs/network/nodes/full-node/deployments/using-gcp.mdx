...
1. Generate a static identity for your PFN by following the guide: [Creating a static identity for a PFN](../../../../../network/nodes/full-node/modify/network-identity-fullnode.mdx#generate-a-static-identity).
