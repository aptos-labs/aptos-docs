...
description: "Learn about ephemeral vs. static identities for public fullnodes (PFN) and how to generate unique network identities for monitoring and persistence."
sidebar:
  label: "Identity"
---
