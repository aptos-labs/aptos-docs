...
3. Download the new [genesis.blob](../../../../../network/nodes/configure/node-files-all-networks/node-files-devnet.mdx#genesisblob) file and the new [waypoint](../../../../../network/nodes/configure/node-files-all-networks/node-files-devnet.mdx#waypointtxt).
