...
description: "Step-by-step guide to update your public fullnode (PFN) with new Aptos releases including source code, Docker, and Terraform deployment methods."
sidebar:
  label: "Upgrade"
---
