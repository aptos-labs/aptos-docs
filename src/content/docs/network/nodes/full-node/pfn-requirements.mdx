...
validator or VFN. You can see the hardware requirements for these, here: [validator and VFN hardware requirements](../../../../network/nodes/validator-node/node-requirements.mdx#hardware-requirements).
