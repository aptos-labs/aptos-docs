...
<Aside type="caution">
  **Using fast sync?**<br />
  ...
  You can read more about fast syncing here: [State sync bootstrapping](../../../../network/nodes/configure/state-sync.mdx#bootstrapping-phase).
</Aside>
...
2. Remove any `seed` peers you may have added to your configuration file. The seeds may be preventing you from
   connecting to the network. Seed peers are discussed in the [Connecting your PFN to seed peers](../../../../network/nodes/full-node/modify/fullnode-network-connections.mdx#connecting-to-seed-peers) section.
