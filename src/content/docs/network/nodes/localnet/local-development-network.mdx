...
description: "Complete guide to running a local Aptos development network using the CLI with Node API, Indexer API, transaction stream, and faucet services."
sidebar:
  label: "With CLI"
---
