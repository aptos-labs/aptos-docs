...
description: "Run a local Aptos network from aptos-core source code for testing modifications to the codebase or Aptos Framework with single validator setup."
sidebar:
  label: "With Source"
---
