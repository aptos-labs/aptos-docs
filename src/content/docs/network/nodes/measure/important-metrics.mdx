...
description: "Key metrics and counters for monitoring Aptos node health including consensus, state sync, networking, and storage performance indicators."
sidebar:
  label: "Key Metrics"
---
...
The following [REST API](/build/apis/fullnode-rest-api) metrics are important:
