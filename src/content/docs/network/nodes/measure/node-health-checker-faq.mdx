...
description: "Frequently asked questions about the Aptos Node Health Checker including troubleshooting evaluation failures and understanding latency tests."
sidebar:
  label: "NHC FAQ"
---
