...
description: "Use the Aptos Node Health Checker (NHC) service to evaluate and monitor the health of your fullnodes by comparing against baseline configurations."
sidebar:
