...
description: "Connect your deployed validator and validator fullnode (VFN) to the Aptos network by initializing staking pools and joining the validator set."
sidebar:
