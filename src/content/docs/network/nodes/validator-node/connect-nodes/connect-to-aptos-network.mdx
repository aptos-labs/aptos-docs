...
<Aside type="caution">
  **MINIMUM STAKING REQUIREMENTS**<br />
  ...
  [staking requirements](../../../../../network/blockchain/staking.mdx#minimum-and-maximum-stake) for the
...
[staking pool operations](../../../../../network/nodes/validator-node/connect-nodes/staking-pool-operations.mdx#initialize-a-staking-pool). Otherwise,
to initialize a delegation pool, follow the instructions in
[delegation pool operations](../../../../../network/nodes/validator-node/connect-nodes/delegation-pool-operations.mdx#initialize-a-delegation-pool).
