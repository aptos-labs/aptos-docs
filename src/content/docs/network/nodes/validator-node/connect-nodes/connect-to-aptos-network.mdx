...
description: "Step-by-step guide to connect your validator and VFN to an Aptos network including stake pool initialization, identity updates, and validator set joining."
sidebar:
  label: "Connecting"
---
