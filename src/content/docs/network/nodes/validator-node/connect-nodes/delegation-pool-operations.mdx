...
description: "Comprehensive guide to delegation pool operations for delegated staking including initialization, delegation, commission management, and allowlisting features."
sidebar:
  label: "Delegation Pool"
---
