...
<Aside type="note">
  Before you proceed, see [Validation on the Aptos blockchain](../../../../../network/blockchain/staking.mdx#validation-on-the-aptos-blockchain) for a brief overview.
</Aside>
...
- Successful leader-validator proposals during the current epoch. Also see [Validation on the Aptos blockchain](../../../../../network/blockchain/staking.mdx#validation-on-the-aptos-blockchain) for the distinction between leader-validator and the voter-validator.
