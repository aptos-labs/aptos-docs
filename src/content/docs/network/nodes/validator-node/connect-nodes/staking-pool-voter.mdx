---
title: "Voting for a Staking Pool"
description: "Guide for staking pool voters to participate in Aptos governance using both the Governance UI and Aptos CLI for proposal voting and delegation."
sidebar:
  label: "Voting"
---
