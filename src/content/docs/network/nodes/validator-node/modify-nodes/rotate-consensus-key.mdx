...
description: "Step-by-step guide to rotate your validator's consensus key for enhanced security including key generation, on-chain updates, and cleanup procedures."
sidebar:
  label: "Rotate Consensus Key"
---
