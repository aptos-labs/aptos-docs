...
description: "Safely shutdown your validator and validator fullnode (VFN) by leaving the validator set and cleaning up resources across different deployment methods."
sidebar:
  label: "Shutdown"
---
