...
1. Update your DNS to swap the [network addresses](../../../../../network/nodes/validator-node/connect-nodes/connect-to-aptos-network.mdx#3-update-on-chain-network-addresses) between the validator and VFN.
