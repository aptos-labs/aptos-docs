...
description: "Hardware, networking, and software requirements for running Aptos validator and validator fullnode (VFN) to ensure optimal performance and stability."
sidebar:
  label: "Requirements"
---
...
| -------------------- | --------------------------------------------------------------------------------|
| CPU                  | 48 threads,	5th Gen AMD EPYC (Turin) or 5th/6th Gen Intel Xeon                   |
| Memory               | 128GB RAM                                                                       |
| Storage              | 3.0 TB NVMe SSD with at least 60K IOPS and 200MiB/s bandwidth                        |
