---
title: "Operator"
description: "Complete operator guide for participating in the Aptos network including validator deployment, network connection, staking setup, and maintaining node liveness."
sidebar:
