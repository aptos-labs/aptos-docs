...
description: "Understand how validator rewards performance is calculated and displayed on the Aptos Validator Leaderboard including proposal success rates and epoch metrics."
sidebar:
  label: "Leaderboard"
---
