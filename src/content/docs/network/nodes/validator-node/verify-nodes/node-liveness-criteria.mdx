---
title: "Node Health"
description: "Verify and monitor the health of your validator and validator fullnode (VFN) using runtime metrics, local monitoring tools, and telemetry data."
sidebar:
  label: "Health Check"
---
