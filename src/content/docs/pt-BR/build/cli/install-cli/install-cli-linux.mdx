---
title: "Instalar a CLI do Aptos no Linux"
description: "Instruções passo a passo para instalar a CLI do Aptos no Linux usando scripts shell, gerenciadores de pacotes ou binários pré-compilados com orientação de solução de problemas."
sidebar:
...
# Instalar via Gerenciador de Pacotes (Optional)
