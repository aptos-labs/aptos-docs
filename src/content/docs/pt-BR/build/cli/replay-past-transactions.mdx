...
description: "Learn how to replay historical blockchain transactions locally for debugging, benchmarking, and gas profiling using the Aptos CLI."
sidebar:
  label: "Replay Transactions"
---
