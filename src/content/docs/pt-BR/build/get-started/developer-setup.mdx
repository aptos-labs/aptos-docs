...
description: "Configure seu ambiente de desenvolvimento para aplicações frontend, contratos inteligentes e full-stack do Aptos com guias passo a passo"
sidebar:
...
<Tabs>
  ...
  <TabItem label="Contrato Inteligente">
    <Steps>
      ...
      4. Build, Compile, and Deploy Contrato Inteligente!
         ...
         <CardGrid>
           <LinkCard
             ...
             title="Create Contrato Inteligente Guide"
  ...
  <TabItem label="Criar Dapp Aptos">
    <Steps>
      ...
      4. Continue reading
         ...
         <CardGrid>
           <LinkCard href="/build/create-aptos-dapp" title="Criar Dapp Aptos" description="Get more information about the tool" />
