---
title: "Установка Aptos CLI на Linux"
description: "Пошаговые инструкции по установке Aptos CLI на Linux с использованием скриптов оболочки, менеджеров пакетов или предварительно скомпилированных бинарных файлов с руководством по устранению неисправностей."
sidebar:
...
# Установка через менеджер пакетов (Optional)
...
#### Установка через AUR (Arch User Repository)
