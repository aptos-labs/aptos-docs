...
description: "Настройте среду разработки для фронтенд, смарт-контрактов и полнофункциональных приложений Aptos с пошаговыми руководствами"
sidebar:
...
<Tabs>
  ...
  <TabItem label="Смарт-контракт">
    <Steps>
      ...
      4. Build, Compile, and Deploy Смарт-контракт!
         ...
         <CardGrid>
           <LinkCard
             ...
             title="Create Смарт-контракт Guide"
  ...
  <TabItem label="Создать Aptos Dapp">
    <Steps>
      ...
      4. Continue reading
         ...
         <CardGrid>
           <LinkCard href="/build/create-aptos-dapp" title="Создать Aptos Dapp" description="Get more information about the tool" />
