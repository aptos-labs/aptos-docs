...
<Aside type="caution">
  If `brew` does not work for you, you can try the steps here: [Komut Dosyası ile Kur](#install-via-script) or [Önceden Derlenmiş İkili Dosyalarla Kur](#install-via-pre-compiled-binaries-backup-method).)
</Aside>
...
# Komut Dosyası ile Kur

<Steps>
  1. Terminalde aşağıdaki komutlardan birini kullanın:
...
# Önceden Derlenmiş İkili Dosyalarla Kur (Backup Method)
