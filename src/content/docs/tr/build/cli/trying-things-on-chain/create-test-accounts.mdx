...
description: "Learn how to create test accounts, fund them with faucet tokens, and send transactions between accounts using the Aptos CLI for testing and development."
sidebar:
  label: "Create Test Accounts"
---
