...
description: "Ön yüz, akıllı sözleşmeler ve tam yığın Aptos uygulamaları için geliştirme ortamınızı adım adım kılavuzlarla kurun"
sidebar:
...
<Tabs>
  ...
  <TabItem label="Ön yüz">
    <Steps>
      1. Initialize Ön yüz Project
  ...
  <TabItem label="Akıllı Sözleşme">
    <Steps>
      ...
      4. Build, Compile, and Deploy Akıllı Sözleşme!
         ...
         <CardGrid>
           <LinkCard
             ...
             title="Create Akıllı Sözleşme Guide"
  ...
  <TabItem label="Aptos Dapp Oluştur">
    <Steps>
      ...
      4. Continue reading
         ...
         <CardGrid>
           <LinkCard href="/build/create-aptos-dapp" title="Aptos Dapp Oluştur" description="Get more information about the tool" />
