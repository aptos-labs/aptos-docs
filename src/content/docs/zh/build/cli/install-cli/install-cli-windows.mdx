...
description: "在 Windows 系统上使用 PowerShell 脚本或预编译二进制文件安装 Aptos CLI 的指南"
sidebar:
  label: "Windows 安装"
---
...
<Steps>
  ...
  2. 打开新的终端并运行 aptos help 验证安装是否成功.
...
<Aside type="caution">
  如果以上方法均不奏效,您需要通过源码构建 CLI(请遵循按照以下步骤操作:[安装特定版本的 Aptos CLI(高级)](/zh/build/cli/install-cli/install-cli-specific-version)
</Aside>
