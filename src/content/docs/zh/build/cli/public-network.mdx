...
<Aside type="caution">
  如果你只是想运行你自己的本地网络进行测试,你可以在这里学习如何[运行一个本地网络](/zh/build/cli/running-a-local-network).
</Aside>
...
以下部分依赖于 Aptos 源代码中的工具.见[从源代码构建 Aptos](/zh/network/nodes/building-from-source)进行设置.
