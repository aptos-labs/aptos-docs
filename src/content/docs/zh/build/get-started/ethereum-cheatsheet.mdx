...
<Aside type="tip" title="分步指南">
  如果你需要完整迁移教程，而不仅是速查表：

  - 从站内的 [Ethereum to Aptos 指南](/zh/build/guides/ethereum-to-aptos) 开始
  - 用 [Billboard 演练](/zh/build/guides/ethereum-to-aptos/billboard/demo) 体验一个简单的 Solidity 到 Move 迁移
  - 再用 [Dutch Auction 演练](/zh/build/guides/ethereum-to-aptos/dutch-auction/demo) 学习更完整的 token 与 object 模式
</Aside>
...
<Tabs>
  <TabItem label="Storage">
    ...
    默认情况下，模块会部署到您的账户地址。对于生产级应用，请考虑部署到 [对象（Objects）](/zh/build/smart-contracts/objects)，这会为每次部署创建一个唯一的地址，并实现可转移的代码所有权。有关实现细节，请参阅 [使用 Objects](/zh/build/smart-contracts/object/using-objects)。

    了解更多: [全局存储（global storage）操作符](https://aptos-labs.github.io/move-book/global-storage.html), [`structs and resources`](https://aptos-labs.github.io/move-book/structs-and-enums.html)
  </TabItem>
  ...
  <TabItem label="Authentication">
    ...
    了解更多: [`signer` 类型](https://aptos-labs.github.io/move-book/primitive-types.html), [`functions`](https://aptos-labs.github.io/move-book/functions.html)
  </TabItem>
  ...
  <TabItem label="Resources & Abilities">
    ...
    了解更多: [`abilities`](https://aptos-labs.github.io/move-book/generics-and-abilities.html), [`structs and resources`](https://aptos-labs.github.io/move-book/structs-and-enums.html)
  </TabItem>
  ...
  <TabItem label="Upgradability">
    ...
    有关确切的兼容性规则，请参阅 [Package Upgrades](https://aptos-labs.github.io/move-book/cli-deploy.html)。
  </TabItem>
