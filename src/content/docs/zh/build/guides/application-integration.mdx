...
<CardGrid>
  <LinkCard href="https://github.com/aptos-labs/aptos-docs/tree/main/apps/app-integration-template" title="应用集成模板" description="极简 Vite + React 示例：并排展示 Ethereum（Sepolia）与 Aptos 的钱包连接、余额、转账、视图调用，以及可选的无序（orderless）nonce 交易。" target="_blank" />
</CardGrid>
