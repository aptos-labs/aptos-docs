---
title: "Swift SDK"
description: "已弃用的社区 Swift SDK。请改用 AptosKit 或官方 SDK。"
sidebar:
  label: "Swift SDK"
  badge:
    text: 已弃用
...
<Aside type="danger" title="已弃用">
  此社区 Swift SDK 已弃用且不再维护。iOS 开发请使用
  [Kotlin Multiplatform SDK 中的 AptosKit](/zh/build/sdks/community-sdks/kotlin-sdk/for-ios-devs/getting-started)，
  或官方 SDK：[TypeScript](/zh/build/sdks/ts-sdk)、
  [Python](/zh/build/sdks/python-sdk)、[Go](/zh/build/sdks/go-sdk) 或
  [Rust](/zh/build/sdks/rust-sdk)。
</Aside>
