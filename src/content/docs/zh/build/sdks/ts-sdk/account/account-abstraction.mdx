...
<Steps>
  ...
  7. 7. 结论
     ...
     ![交易签名](~/images/account-abstraction/minimal-guide-transaction-signature.png)
</Steps>
...
<Steps>
  ...
  8. 8. 结论
     ...
     ![交易签名](~/images/account-abstraction/complex-guide-transaction-signature.png)
</Steps>
...
下图展示了启用账户抽象功能的用户体验流程.![账户抽象用户体验](~/images/account-abstraction/account-abstraction-ux.png)
