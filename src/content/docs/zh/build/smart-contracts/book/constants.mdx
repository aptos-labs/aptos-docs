---
title: "常量"
description: "中文指南：learn about constants in move programming language for aptos smart contract development."
sidebar:
  label: "Constants"
---
...
虽然常量中可以使用小写字母`a`到`z`,但根据[通用风格指南](/zh/build/smart-contracts/book/coding-conventions),建议只使用大写字母`A`到`Z`,单词之间用下划线`_`分隔.
