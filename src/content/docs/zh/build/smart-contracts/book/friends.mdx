---
title: "友元模块"
description: "中文指南：learn about friend functions in move for controlled access to internal module functionality and secure interfaces."
sidebar:
  label: "Friends"
---
...
关于函数可见性的详细信息,请参阅 [函数](/zh/build/smart-contracts/book/functions) 章节中的\_可见性\_部分.
...
- 友元模块必须位于同一账户地址下(注意:这不是技术限制,而是当前策略要求,未来\_可能\_会放宽):
