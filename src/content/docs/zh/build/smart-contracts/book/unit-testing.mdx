---
title: "单元测试"
description: "中文指南：learn about unit testing in move programming language for aptos smart contract development."
sidebar:
  label: "Unit Testing"
---
...
可以使用 `aptos move test` 命令运行 Move 包的单元测试.更多信息请参阅 [package](/zh/build/smart-contracts/book/packages) .
