---
title: "创建包 (Move)"
description: "中文指南：learn about create package for move smart contract development on aptos blockchain."
sidebar:
...
<Aside type="note">
  ...
  如果您还没有安装 Aptos CLI,请参阅 [CLI 部分](/zh/build/cli)
</Aside>
...
<Steps>
  1. aptos move init
     ...
     <Aside type="note">
       您还可以从 [模板](/zh/build/cli/start-from-template) 创建一个 Move 包.
     </Aside>
  ...
  2. 更新 Move.toml
     ...
     4. `dependencies`: 您可能希望使用 `AptosFramework` 和其他 [第三方依赖](/zh/build/smart-contracts/third-party-dependencies)
