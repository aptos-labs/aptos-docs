---
title: "对象代码部署"
description: "中文指南：learn about deployment for move smart contract development on aptos blockchain."
sidebar:
  label: "Deployment"
---
...
本文档介绍如何将代码部署到 [Objects](/zh/build/smart-contracts/objects).这是将代码部署到区块链的推荐方式,因为这减少了部署的复杂性,并安全地管理代码所有者的访问控制策略.请注意,在此上下文中,代码是指 [packages](https://aptos-labs.github.io/move-book/modules-and-packages.html).
