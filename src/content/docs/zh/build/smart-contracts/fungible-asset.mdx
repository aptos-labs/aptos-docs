...
description: "中文指南：learn about fungible asset for move smart contract development on aptos blockchain."
sidebar:
...
你可以在[这里](/zh/move-reference/mainnet/aptos-framework/fungible_asset)找到 FA 标准提供的完整函数集.
