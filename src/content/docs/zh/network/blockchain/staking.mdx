...
4. 运营者进行验证并获得奖励。
5. 质押池会自动锁定固定时长（由 Aptos 治理设定）且到期后自动续期。锁定期结束前不能提取任何已质押金额，详见 [stake.move#L728](https://github.com/aptos-labs/aptos-core/blob/00a234cc233b01f1a7e1680f81b72214a7af91a9/aptos-move/framework/aptos-framework/sources/stake.move#L728)。
...
<Aside type="note">
  完整代码请参阅 [stake.move 的 epoch 边界触发项章节](https://github.com/aptos-labs/aptos-core/blob/256618470f2ad7d89757263fbdbae38ac7085317/aptos-move/framework/aptos-framework/sources/stake.move#L1036)。
</Aside>
