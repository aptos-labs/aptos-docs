...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 测试网 | 已停止                                                                                                                                                                            | [https://github.com/aptos-labs/aptos-networks/blob/main/testnet/backups/gcs.yaml](https://github.com/aptos-labs/aptos-networks/blob/main/testnet/backups/gcs.yaml) |
| 主网  | [https://github.com/aptos-labs/aptos-networks/blob/main/mainnet/backups/s3-public.yaml](https://github.com/aptos-labs/aptos-networks/blob/main/mainnet/backups/s3-public.yaml) | [https://github.com/aptos-labs/aptos-networks/blob/main/mainnet/backups/gcs.yaml](https://github.com/aptos-labs/aptos-networks/blob/main/mainnet/backups/gcs.yaml) |
