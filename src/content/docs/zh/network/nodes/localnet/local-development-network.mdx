...
<Steps>
  ...
  5. 等待网络启动
     ...
     - [Indexer API](/zh/build/indexer/indexer-api):这是一个提供丰富读访问功能的 [GraphQL](https://graphql.org/) API, 专门用于索引区块链数据.点击上述 Indexer API 的链接(默认为 http://127.0.0.1:8090 ),即可打开 Hasura Console.这是一个 Web 界面,能帮助你方便地查询 Indexer GraphQL API.
